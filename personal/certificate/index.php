    ...
    <div class="mobile_lk mb-5">
        ...
        <div class="col-md-9 mb-5" id="content_box">
            <div class="hides" id="about_contacts">
                <h4 class="mb-4"><b>Подарочный сертификат</b></h4>
                <div class="row">
                    <div class="col-12">
                        <?$APPLICATION->IncludeComponent(
                            "bitrix:catalog",
                            "oshisha_catalog.catalog_personal_certificate",
                            array(
                                ...
                                "SEF_MODE" => "Y",
                                "SEF_FOLDER" => "/personal/certificate/",
                                "AJAX_MODE" => "N",
                                "AJAX_OPTION_JUMP" => "N",
                                "AJAX_OPTION_STYLE" => "Y",
                                ...
                                "SIDEBAR_PATH" => "",
                                "COMPONENT_TEMPLATE" => "oshisha_catalog.catalog_personal_certificate",
