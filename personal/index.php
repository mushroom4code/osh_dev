...
if (!$USER->IsAuthorized()) {
    ...
    ?>
    <div class="mobile_lk mb-5 flex md:flex-row flex-col  <? if ($APPLICATION->GetCurPage() != '/personal/'): ?>private<? endif; ?>">
        ...
        <div class="md:hidden flex flex-row md:mb-0 mb-6 items-center md:mt-0 mt-6">
            <svg width="34" height="35" viewBox="0 0 34 35" class="mr-3" xmlns="http://www.w3.org/2000/svg">
