...
if (!$USER->IsAuthorized()) {
    ...
    <div class="mobile_lk flex lg:flex-row flex-col md:mt-4 <?php if ($APPLICATION->GetCurPage() != '/personal/'): ?>private<?php endif; ?>">
        <?php
        if ($mobile->isMobile()) { ?>
        ...
        <?php if ($APPLICATION->GetCurUri() != '/personal/'): ?>
            <div class="md:hidden flex flex-row items-center md:p-0 p-4">
