            ...
            <div class="box_msk mb-5 d-flex">
                <div class="width_50">
                    ...
                    <div class="flex-column d-flex">
                        ...
                        <div class="d-flex row_section mb-3">
                            ...
                            <div class="delivery_description">Сделай <span class="red_text">заказ до 19:00</span>,
                                доставим на следующий день с 11 до 22 (кроме вс)<br/>доставка от 299 руб, <span
                                        class="red_text">бесплатно для заказов от 4000 руб</span>.
                            </div>
                        </div>
                        <div class="d-flex row_section mb-3">
                            ...
                            <div class="delivery_description">Доставка через постаматы Pickpoint. <span
                                        class="red_text">Самая недорогая доставка</span>.<br/>Стоимость рассчитается
                                автоматически в корзине.
                            </div>
                        </div>
                    </div>
                ...
                <div class="width_50">
                    ...
                    <div class="d-flex justify-content-between box_picture_info  mb-3">
                        ...
                        <span class="ml-2 delivery-trigger   d-flex align-items-center">Доставка по Москве и МО до пункта выдачи или постамата CDEK, 5post, Pickpoint</span>
                    </div>
                </div>
            </div>
            <div class="box_reg mb-5 d-flex">
                <div class="width_50">
                    ...
                    <p class="delivery_description">Доставка по России осуществляется всеми удобными для Вас
                        транспортными компаниями, а также через пункты выдачи или постаматы 5post, Pickpoint, CDEK.</p>
                    <p class="mb-4 delivery_description">При подтверждении заказа согласуем с Вами удобную ТК или способ
                        доставки<br/>
                        <span class="red_text ">ПЭК, Деловые линии, Байкал Сервис, Кит, Энергия, CDEK и другие.</span><br/><br/>Стоимость
                        доставки рассчитывается по тарифам ТК или курьерской службы при оформлении заказа на сайте или
                ...
                <div class="width_50">
                    ...
                    <div class="d-flex justify-content-between box_picture_info  mb-3">
                        <span class="box_delivery_box"></span>
                        <span class="ml-2 delivery-trigger d-flex align-items-center">Доставка до постамата или пункта выдачи</span>
                    </div>
                </div>
            </div>
        </div>
