...
?><div id="content_box_delivery" class="box_boxes_delivery static">
	...
	<div class="d-flex flex-column" id="delivery_method">
		...
		<p class="delivery_description" style="margin:0 0 40px">
 ...
 <span class="d-flex align-items-center mr-3 "> <i class="fa fa-circle header_icon" aria-hidden="true"></i> </span>
					<div class="delivery_description">
						 Сделай <span class="red_text">заказ до 15:00 (пнд-птн)</span>, доставим до 21:00 в этот же день<br>
 <span class="red_text">стоимость доставки 299 руб.</span><br>
					</div>
				</div>
				<div class="d-flex row_section mb-3">
 <span class="d-flex align-items-center mr-3 "> <i class="fa fa-circle header_icon" aria-hidden="true"></i> </span>
					<div class="delivery_description">
						 Сделай <span class="red_text">заказ до 18:00</span>, доставим с 21 до 02 в этот же день (кроме сб и вс)<br>
 ...
 <span class="d-flex align-items-center mr-3 "> <i class="fa fa-circle header_icon" aria-hidden="true"></i> </span>
					<div class="delivery_description">
						 Доставка через постаматы Pickpoint. <span class="red_text">Самая недорогая доставка</span>.<br>
 ...
 <span class="box_delivery_car"></span> <span class="ml-2 delivery-trigger d-flex align-items-center">Собственная курьерская служба - оригинальный товар напрямую со склада!</span>
			...
			<div class="d-flex justify-content-between box_picture_info mb-3">
 <span class="box_delivery_box"></span> <span class="ml-2 delivery-trigger d-flex align-items-center">Доставка по Москве и МО до пункта выдачи или постамата CDEK, 5post, Pickpoint</span>
			</div>
		</div>
	</div>
	<div class="box_reg mb-5 d-flex">
		<div class="width_50">
			...
			<p class="delivery_description">
				 Доставка по России осуществляется всеми удобными для Вас транспортными компаниями, а также через пункты выдачи или постаматы 5post, Pickpoint, CDEK.
			</p>
			<p class="mb-4 delivery_description">
