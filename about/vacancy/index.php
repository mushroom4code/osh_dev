    ...
    <div class="mt-4 mb-5">
        ...
        <div class="mb-4">
            <div class="p-lg-5 p-md-5 p-3 bg-gray-white br-10 font-16">
                ...
                портфеле
                компании сегодня: кальянные смеси, электронные системы доставки никотина, жевательный табак, кальяны и
                комплектующие.<br>
                <br>
                ...
                HoReCa,
                Retail) Ответственно задаем тренды качественного Service Level в городах присутствия, поэтому
                ...
                готов
                развиваться вместе с нами! Сегодня <b>команде OSHISHA необходимы</b> результативные сотрудники,
                down-middle-top менеджмент. <br>
                <br>
                <b>Мы ценим в команде</b>: Профессионализм. Желание развиваться. Ответственность за результат.
                Позитивный
                настрой. Осознанную инициативу. <br>
                <br>
        ...
        <div class="mb-5">
            ...
            <p class="mb-3">
                Телефон : 8 (800) 600-44-24
            </p>
            <p class="mb-3">
                Почта : info@oshisha.net
            </p>
        </div>
