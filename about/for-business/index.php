...
<div id="content_box_business " class="static">
        ...
        <div class="mb-16">
            ...
            <div class="flex md:flex-row flex-col justify-between">
                <div class="flex md:w-1/3 w-full flex-col mb-3 items-center">
                    ...
                    <span class="flex items-center justify-center mt-3 text-sm font-normal text-textLight
                     dark:text-textDarkLightGray">
                ...
                <div class="flex md:w-1/3 w-full flex-col mb-3 items-center">
                    <img width="150" height="150" class="invert-0 dark:invert"
                         ...
                         alt="oshisha">
                    <span class="flex items-center justify-center mt-3 text-sm text-textLight font-normal
                    dark:text-textDarkLightGray">
        ...
        <div class="mb-16">
            ...
            <div class="flex justify-between md:flex-row flex-col">
                <div class="flex flex-col md:w-1/3 w-full justify-between">
                    <p class="p-7 rounded-lg bg-textDark text-sm dark:bg-darkBox mr-5 mb-5 h-full font-normal dark:font-light">
                    ...
                    <div class="flex justify-center items-center p-5 rounded-lg bg-textDark
    ...
    <div id="delivery_payment" class="mb-6">
        <h4 class="md:text-3xl text-2xl mt-5 mb-8 font-bold dark:font-medium text-textLight dark:text-textDarkLightGray">
                ...
                <div class="box_with_brands_parents flex md:flex-row flex-col flex-wrap">
                    <?php foreach ($resGetHLB as $item) { ?>
                        <div class="box_with_brands p-5 mr-3 mb-3 md:w-48 md:h-32 h-auto w-full rounded-lg
                         border-textDarkLightGray border dark:border-darkBox">
