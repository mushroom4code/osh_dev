    ...
    <div class="mb-5 static" id="box_contacts">
            ...
            <div class="row_section d-flex mb-3">
                <div class="d-flex row_section mb-3 width_50 mr-3 box_row">
                    ...
                    <b class="text_delivery text_delivery_next">г. Москва, ул. Краснобогатырская, 2с2 <span
                                class="red_text">(Пешком)</span><br/>
                        (вход со стороны Краснобогатырской)</b>
                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                <div class="form-control input_lk input_files drop-zone" id="drop-zone">
                                    ...
                                    <div class="drop-message">Приложить можно до 10 изображений в форматах .jpg, .gif,
                                        .png
        ...
        <div class="width_50 mb-5">
            <div class="box_with_icons">
                <a href="<?= $option->TG; ?>" class="mr-5 telegram_icons" target="_blank"></a>
                <a href="<?= $option->VK_LINK ?>" class="mr-5 vk_icons" target="_blank"></a>
                <a href="https://api.whatsapp.com/send?phone=<?= $option->PHONE_WTS ?>" class="mr-4" target="_blank"> <i
                            class="fa fa-whatsapp icons_theme" aria-hidden="true"></i></a>
                <a href="<?= $option->DZEN ?>" target="_blank"><img class="dzen_contacts"
                                                                    src="<?= SITE_TEMPLATE_PATH ?>/images/dzen.svg"></a>
            </div>
        </div>
