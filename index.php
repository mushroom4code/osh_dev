...
if ($showUserContent) {
    ...
    <div class="bx-content static_wrap">
        <div class="p-lg-5 p-md-5 p-4 bg-gray-blue bg-image-ugol index-ugol br-10"
            ...
            <div class="d-flex justify-content-lg-between justify-content-md-between flex-column height_100">
                <div>
                    <h5 class="font-40 font-weight-bold color-black mb-lg-5 mb-md-3 mb-3">Собственное
                        производство</h5>
                    <p class="mb-4 font-m-13">
                        В 2019 году мы запустили собственный бренд<br>
                        угля «Углище», который объединяет в себе<br>
                        традиции, стандарты и опыт качественной угольной <br>
                        индустрии.
                    </p>
                </div>
            </div>
