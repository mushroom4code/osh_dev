...
?>
    <div class="slider single-items box_slide box_with_actual_none">
        ...
        ?>
		  ...
		  <span class="new_custom_button_slick_left" aria-hidden="true"><i class="fa fa-angle-left" aria-hidden="true"></i></span>
		  <span class="new_custom_button_slick_right" aria-hidden="true"><i class="fa fa-angle-right" aria-hidden="true"></i></span>
		  </div>
    </div>
