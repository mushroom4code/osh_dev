...
<div class="brand_detail mt-8">
    <div class="brand_detail_first flex md:flex-row flex-col md:items-center mb-16">
        ...
        <div class="brand_name md:ml-4 ml-0">
            ...
            <span class="text-sm font-normal dark:font-light">
...
<h1 class="md:text-2xl text-lg md:mb-10 mb-5 dark:font-normal font-medium text-textLight dark:text-textDarkLightGray">
    Товары бренда <?= $arResult['UF_NAME'] ?>
</h1>
