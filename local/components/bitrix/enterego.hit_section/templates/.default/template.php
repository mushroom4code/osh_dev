...
foreach ($arResult['SECTIONS_ITEMS'] as $sectionKey => $sectionItems) {
    if (!empty($sectionItems)) { ?>
        <div class="md:mb-14 mb-7">
            <div class="flex flex-col md:flex-row justify-between items-center mb-4">
                <h2 class="md:text-3xl text-2xl mb-2 font-semibold dark:font-normal text-textLight dark:text-textDarkLightGray">
                    <?= $arResult['SECTIONS'][$sectionKey]['NAME'] ?>
                </h2>
                <a href="/hit/<?= $arResult['SECTIONS'][$sectionKey]['CODE'] ?>/"
                   class="md:text-xl text-lg mb-2 font-medium dark:font-light underline pointer text-light-red dark:text-white"
