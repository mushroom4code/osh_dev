...
elseif (isset($_REQUEST["del_filter"]))
    $_CHECK = array();
elseif (\Enterego\EnteregoHitsHelper::checkIfHits($APPLICATION))
    $_CHECK = array();
...
//Enterego - формирование отбора для обновление страницы по фильтру
if (isset($_REQUEST["ajax_filter"]) && $_REQUEST["ajax_filter"] === "y") {

} elseif ($arParams["XML_EXPORT"] === "Y" && $_REQUEST["mode"] === "xml") {
    $this->setFrameMode(false);
    ob_start();
