...
use CIBlockElement;
use CIBlockSection;
\Bitrix\Main\Loader::includeModule("up.boxberrydelivery");
 ...
 */
class PickupHandler extends \Bitrix\Sale\Delivery\Services\Base
{
	...
	{
		return Loc::getMessage("SALE_PDLVR_HANDL_CUSTOM_TITLE2");
	}
