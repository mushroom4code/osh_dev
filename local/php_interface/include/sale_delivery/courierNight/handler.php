 ...
 */
class CourierNightHandler extends \Bitrix\Sale\Delivery\Services\Base
{
	...
	{
		return Loc::getMessage("SALE_CDLVR_HANDL_CUSTOM_TITLE_NIGHT");
	}
	...
	{
		return Loc::getMessage("SALE_CDLVR_HANDL_CUSTOM_DESCRIPTION_NIGHT");
	}
...
*/
	...
	protected function calculateConcrete(\Bitrix\Sale\Shipment $shipment = null)
	{
		...
		file_put_contents($_SERVER['DOCUMENT_ROOT'].'/upload/gorod.txt', $LOCATION.PHP_EOL, FILE_APPEND);
		$arGorod = array('0000077344', '0000077774', '0000054606');
		//0000077344 - зеленоград
		//0000077774 - щербинка
		//0000054606 - Одинцово
		...
		elseif( $price < 4000 && ($distance <= 5 || in_array($LOCATION,$arGorod)) )
		{
			$ResultPrice = 399;
		}
		elseif( $price >= 4000 && ($distance < 5 || in_array($LOCATION,$arGorod)) )
