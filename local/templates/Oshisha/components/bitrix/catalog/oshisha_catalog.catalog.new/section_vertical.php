...
<div class="row mb-4 box_with_prod">
    <?php if ($isFilter) : ?>
        <div class="col-lg-3 col-md-3 col-10  col-sm-4 box_filter_catalog
    ...
    <div class="pb-4 <?= (($isFilter) ? "col-lg-9 col-md-8 col-sm-7" : "col") ?> padding_product_box">
        <div class="row mb-4">
        ...
        <div class="box_for_tasted mb-3"></div>
        <?php
