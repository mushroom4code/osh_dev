    ...
    <noindex>
        ...
        <h4 class="flex flex-row items-center justify-between mt-5 text-3xl font-medium dark:font-normal text-textLight
            ...
            <span><?= GetMessage("AUTH_REGISTER") ?></span>
                <a href="<?= $arResult["AUTH_AUTH_URL"] ?>" rel="nofollow" class="flex flex-row items-center">
                    ...
                    <span class="font-semibold text-textLight dark:text-white lg:text-lg text-sm dark:font-light">Авторизация</span>
                </a>
        </h4>
