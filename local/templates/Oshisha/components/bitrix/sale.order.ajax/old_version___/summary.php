			...
			<table class="bx_ordercart_order_sum">
				<tbody>
					...
					<tr>
						...
						{
							?>
							<td class="custom_t2 "><?=$arResult["ORDER_PRICE_FORMATED"]?></td>
							<?
						}
						?>
					</tr>
					...
					if (strlen($arResult["PAYED_FROM_ACCOUNT_FORMATED"]) > 0)
					{
						...
						<tr>
							...
							<td class="custom_t2" class=""><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></td>
						</tr>
						<tr>
							<td class="custom_t1" colspan="<?=$colspan?>" class="itog"><?=GetMessage("SOA_TEMPL_SUM_PAYED")?></td>
							<td class="custom_t2" class=""><?=$arResult["PAYED_FROM_ACCOUNT_FORMATED"]?></td>
						</tr>
						<tr>
							<td class="custom_t1 fwb" colspan="<?=$colspan?>" class="itog"><?=GetMessage("SOA_TEMPL_SUM_LEFT_TO_PAY")?></td>
							<td class="custom_t2 fwb" class=""><?=$arResult["ORDER_TOTAL_LEFT_TO_PAY_FORMATED"]?></td>
						</tr>
					<?
					}
					else
					{
						...
						<tr>
							...
							<td class="custom_t2 fwb" class=""><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></td>
						</tr>
					<?
					}
					?>
