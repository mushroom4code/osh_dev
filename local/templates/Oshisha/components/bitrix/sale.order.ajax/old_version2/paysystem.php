<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die(); ?>
	...
	<div class="makeorder_content_left_pay">
		<h4>3. Способы оплаты</h4>
		<div class="bx_pay_wrap">
			<?
			...
			foreach ($arResult["PAY_SYSTEM"] as $arPaySystem) {
				...
				if ($DELVERY_PAY == 1 && $arPaySystem['ID'] != 14) continue;
				if ($DELVERY_PAY == 1 && $arPaySystem['ID'] == 14) $arPaySystem["CHECKED"] = 'Y';
