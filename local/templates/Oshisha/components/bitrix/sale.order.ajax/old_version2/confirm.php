...
if (!empty($arResult["ORDER"]))
{
	...
	<?//	file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log_pay.txt', print_r($arResult["PAY_SYSTEM"],1));
...
<script>
	$(document).ready(function(){
		if(typeof(ym) != 'undefined') {
			ym(19011055,'reachGoal','send_form_oformit_zakaz');
		}
		gtag('event', 'click', { 'event_category': 'send_form_oformit_zakaz', 'event_label': 'main'});
	});
</script>
<?}
else
