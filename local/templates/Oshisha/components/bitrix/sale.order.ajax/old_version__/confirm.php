	...
	<table class="sale_order_full_table">
		<tr>
			<td>
				...
				<?if( $arResult["PAY_SYSTEM"]['ID'] == 2 ):?> <br /><br />
				 <b>Ожидайте звонка оператора, и после подтверждения заказа на указанную вами почту мы вышлем вам счет.</b>
				<?endif;?>
			</td>
		</tr>
	</table>
...
?>
<script>
purchaseCounter('<?=$arResult["ACCOUNT_NUMBER"]?>');
</script>
