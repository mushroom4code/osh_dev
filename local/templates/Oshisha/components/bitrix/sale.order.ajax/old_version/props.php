...
?>
<div class="section section_complete_profile" style="display:none;">
...
<div class="bx-soa-section-content" id="bx-soa-properties">
	<div class="row">
		<div class="bx-soa-customer p-0">
		<?
...
$bHideProps = false;
		...
		?>
					...
					<?	
					PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"], $arResult, array(), array(26,12));
					PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_Y"], $arParams["TEMPLATE_LOCATION"], $arResult, array(), array(26,12));
					PrintPropsForm($arResult["ORDER_PROP"]["RELATED"], $arParams["TEMPLATE_LOCATION"], $arResult, array(), array(26,12));
					?>
