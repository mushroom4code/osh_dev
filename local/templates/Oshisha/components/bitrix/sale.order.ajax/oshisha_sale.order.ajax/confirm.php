                    ...
                    <div class="flex flex-col">
                        <a href="/personal/orders/<?= $arResult["ORDER"]["ACCOUNT_NUMBER"] ?>/"
                           ...
                           dark:font-normal mb-5 flex flex-row items-center md:mr-5 mr-0
                            ...
                            <span class="font-semibold dark:font-light md:text-md text-sm dark:text-textDarkLightGray text-lightGrayBg"> Подробности заказа</span>
                        </a>
                        <a href="/catalog/" class="bx-advertisingbanner-btn text-lightGrayBg dark:text-white w-fit
                            ...
                            <span class="font-semibold dark:font-light md:text-md text-sm dark:text-textDarkLightGray text-lightGrayBg">Продолжить покупки</span>
                        </a>
                    </div>
                </div>
