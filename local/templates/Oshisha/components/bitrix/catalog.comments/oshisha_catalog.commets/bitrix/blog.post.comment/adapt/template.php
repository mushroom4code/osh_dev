                                    ...
                                    if (empty($arResult["User"])) {
                                        ...
                                        <div class="blog-comment-field blog-comment-field-user">
                                            <div class="blog-comment-field blog-comment-field-author">
                                                ...
                                                <span><input maxlength="255" size="30" tabindex="3" type="text"
                                    ...
                                    <? if ($arParams["NOT_USE_COMMENT_TITLE"] != "Y") {
                                        ...
                                        <div class="blog-comment-field blog-comment-field-title">
                                            <div class="blog-comment-field">
                                                ...
                                                <span><input size="70" type="text" name="subject" id="subject"
                                                             value=""></span>
                                                <div class="blog-clear-float"></div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="feed-com-files">
                                                    ...
                                                    <div class="feed-com-files-cont">
                                                        ...
                                                        foreach ($arParams["arImages"][$comment["ID"]] as $val) {
                                                            ?><span class="feed-com-files-photo"><img src="<?= $val["small"] ?>"
                                                                                                      alt="" border="0"
                                            ...
                                            <div class="blog-comment-meta">
                                                ...
                                                if ($bCanUserComment === true) {
                                                    if ($USER->IsAuthorized()) {
                                                        ...
                                                        <span class="blog-comment-answer"><a href="javascript:void(0)"
                                                                                             onclick="return replyCommentNew('<?= $comment["ID"] ?>', '<?= $comment["POST_ID"] ?>')"><?= GetMessage("B_B_MS_REPLY") ?></a></span>
                                                ...
                                                if (intval($comment["PARENT_ID"]) > 0) {
                                                    ...
                                                    <span class="blog-comment-parent"><a
                                                                href="#<?= $comment["PARENT_ID"] ?>"><?= GetMessage("B_B_MS_PARENT") ?></a></span>
                                                    <span class="blog-vert-separator"></span>
                                                    <?
                                                }
                                                ...
                                                if ($comment["CAN_EDIT"] == "Y") {
                                                    ...
                                                    <span class="blog-vert-separator"></span>
                                                    <span class="blog-comment-edit"><a href="javascript:void(0)"
                                                ...
                                                <? if ($arParams["AJAX_POST"] == "Y"): ?>
                                                    <a href="javascript:void(0)"
                                                       onclick="if(confirm('<?= GetMessage("BPC_MES_DELETE_POST_CONFIRM") ?>')) deleteComment('<?= $comment["urlToDelete"] . "&" . bitrix_sessid_get() ?>&IBLOCK_ID=<?= $iblockId; ?>&ELEMENT_ID=<?= $elementId; ?>', '<?= $comment["ID"] ?>');"
                                                       title="<?= GetMessage("BPC_MES_DELETE") ?>">
                                                <? else: ?>
                                                    <a href="javascript:if(confirm('<?= GetMessage("BPC_MES_DELETE_POST_CONFIRM") ?>')) window.location='<?= $comment["urlToDelete"] . "&" . bitrix_sessid_get() ?>&IBLOCK_ID=<?= $iblockId; ?>&ELEMENT_ID=<?= $elementId; ?>'"
                                                       title="<?= GetMessage("BPC_MES_DELETE") ?>">
                                                <?endif;
                                                ?>
                                                ...
                                                if ($comment["urlToSpam"] <> '') {
                                                    ?>
                                                    <span class="blog-vert-separator"></span>
                                                    <span class="blog-comment-delete blog-comment-spam"><a
                                                                href="<?= $comment["urlToSpam"] ?>"
                                                                title="<?= GetMessage("BPC_MES_SPAM_TITLE") ?>"><?= GetMessage("BPC_MES_SPAM") ?></a></span>
                                                    <?
                                                }
                                                if ($arParams["SHOW_RATING"] == "Y") {
                                                    ?>
            ...
            if ($arResult["is_ajax_post"] != "Y") {
                ...
                if ($USER->IsAuthorized()) {
                    if ($arResult["CanUserComment"]) {
                        ...
                        ?>
                        <div class="blog-add-comment"><a class="" href="javascript:void(0)" onclick="return editCommentNew('0',
                            <?= $arParams["ID"] ?>)" id="<?= $arParams["ID"] ?>">
                                <i class="fa fa-comment-o" style="font-weight: 900;" aria-hidden="true"></i> &nbsp
                    ...
                    <div class="new_box bow_width mt-5 d-flex flex-row align-items-center justify-content-around">
                        <p>Добавьте отзыв, заполнив личные данные, или сначала войдите на сайт.</p>
                        <a class="link_auth link_header_box_new" href="javascript:void(0)">Войти / Зарегистрироваться</a>
                    </div>
                    <script>
