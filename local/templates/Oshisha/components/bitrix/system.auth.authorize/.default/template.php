...
<div class="bx-auth">
    ...
    <form name="form_auth" method="post" target="_top" action="<?= $arResult["AUTH_URL"] ?>">
        ...
        <table class="bx-auth-table">
            <div class="mb-3">
                <p class="dark:text-textDarkLightGray font-semibold dark:font-medium text-dark mb-2 md:text-md text-sm">
            ...
            dark:bg-dark-red bg-light-red py-2.5 px-4 rounded-5 w-40 text-sm" name="Login"
