                ...
                <div class="basket-coupon-section">
                    <div class="basket-coupon-block-field">
                        <div class="basket-coupon-block-field-description mb-4">
                            <span class="text_filter_basket text-md text-textLight dark:text-textDarkLightGray
                        ...
                        <div class="form">
                            <div class="form-group" style="position: relative;">
                                ...
                                outline-none dark:text-grayIconLights py-3 px-4 rounded-7 text-textLight text-md mb-4
                                ...
                                <div class="basket-checkout-block">
                                    ...
                                    text-md dark:bg-dark-red bg-light-red py-3 px-4 rounded-5 basket-coupon-block-coupon-btn">
                                        Применить
                                    </button>
                                </div>
                            </div>
