    ...
    <?php if ($arParams['LOOK_LIKE'] === true) { ?>
        <a class="icon_like method flex flex-col items-center" title="Нравится" data-method="like"
           ...
           href="javascript:void(0);">
            <svg width="25" height="24" viewBox="0 0 20 19" class="md:w-6 md:h-6 h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <article class="like_span mt-1 md:block hidden <?= empty($arParams['HIDE_LIKE_COUNT']) ? "" : "hidden" ?>" id="likes">
        ...
        if ($USER->IsAuthorized()) { ?>
            <a class="product-item__favorite-star method"
               ...
               title="Добавить в избранное" data-method="favorite">
                <svg width="28" height="27" viewBox="0 0 25 26" class="md:w-7 md:h-7 h-5 w-5" fill="none" xmlns="http://www.w3.org/2000/svg">
