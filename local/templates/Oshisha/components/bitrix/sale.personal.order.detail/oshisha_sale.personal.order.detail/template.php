            ...
            <div class="mb-3">
                <div class="sale-order-detail-card">
                    <div class="title_order_detail">
                        <div class="flex-row flex bg-textDark dark:bg-darkBox md:px-8 px-5 xl:py-3 md:py-3 py-1/4 md:rounded-t-3xl
                        rounded-t-lg relative">
                            <div class="flex-row flex w-1/2 items-center">
                                <h4 class="font-medium dark:font-medium xl:text-2xl text-lg mb-0 text-textLight mr-3
                                 dark:text-textDarkLightGray">
                                    Заказ № <?= $arResult["ACCOUNT_NUMBER"] ?>
                                </h4>
                                <p class="sale-order-detail-props font-semibold xl:text-lg md:text-md text-sm  mb-0
                                dark:font-medium dark:text-textDarkLightGray text-textLight">
                                    от <?= $arResult["DATE_INSERT_FORMATED"] ?>
                                </p>
                            </div>
                            <span class="mb-1 md:w-1/2 xl:text-lg md:text-md text-sm font-medium h-full absolute top-0 right-0
