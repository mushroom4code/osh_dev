...
if ($GLOBALS['SEE_PRODUCT_AUTH_' . $arResult['ID']] == 'Нет'  && CATEGORY_DISABLED || empty($arResult['ITEMS'])  && CATEGORY_DISABLED) {
    ...
    <div class="row<?= $themeClass ?>">
        <div class="col p-0">
            ...
            <div class="mb-4 catalog-section <?= $col_orientation . ' ' . $classOpt ?>"
