...
<div>
    <header class="bg-white dark:bg-dark sticky top-0 z-40 border-b md:border-0 border-white dark:border-grayIconLights">
        <?php if (CHECKED_INFO) {
            ...
            <div class="md:container flex flex-row justify-between items-center">
             ...
             hover:text-hover-red">
                ...
                <div class="flex flex-row items-center">
                    ...
                    <?=$_SESSION['themeQuestion']?>
                    <div class="w-14 h-7 bg-gray-slider-arrow <?= $_SESSION['themeQuestion'] !== '1' ? 'pulse' : ''?>
                    flex flex-row justify-between items-center px-1 rounded-full dark:bg-gray-box-dark header-switch"
