            ...
            <div
                ...
                <div className="flex md:flex-row flex-col js-parent-flex">
                    ...
                    <div className="flex flex-col justify-between md:w-1/2 w-full">
                        <div
                            className="prices-box ml-lg-4 ml-md-4 ml-0 mb-lg-4 mb-md-2 mb-2 flex flex-row items-center">
                            <div className="base-price group-prices product-item-detail-price-current text-3xl mb-2
                             font-medium text-lightGrayBg dark:text-textDarkLightGray mr-5">{price}₽
                            </div>
                            <div
                                className="add-to-basket box-basket flex flex-row items-center
                                 bx_catalog_item_controls mb-3">
                                <div className="product-item-amount-field-contain-wrap mr-4">
                                    <div className="product-item-amount-field-contain flex flex-row items-center">
                                        <a className="btn-minus minus_icon no-select add2basket
                                       rounded-full md:py-0 md:px-0 py-3.5 px-1.5
                                        ...
                                        <div className="product-item-amount-field-block">
                                            <input className="product-item-amount card_element inputBasketOpenWindow
                                             dark:bg-grayButton bg-textDarkLightGray focus:border-none text-center
                                              border-none text-sm shadow-none py-2.5 px-3 md:mx-2 mx-1 outline-none
                                      ...
                                      no-select add2basket cursor-pointer flex items-center
                                    ...
                                    <div className="alert_quantity" data-id={productId}></div>
                                </div>
                            </div>
                        </div>
                        <div className="props-box ml-lg-4 ml-md-4 ml-0 flex md:flex-row flex-col
                         justify-between items-end">
                            ...
                            <a className="text-light-red text-lg dark:text-dark-red font-medium underline"
