    ...
    return (
        <div
            ...
            <p className='flex flex-row mb-6'>
                <Car/>
                <span className="font-medium md:text-xl text-lg text-textLight dark:text-textDarkLightGray ml-3">Укажите адрес и способ доставки</span>
            </p>
            <div className="flex flex-col">
                <div className='md:mb-4 mb-3'>
                    {curDelivery.PRICE_FORMATED !== undefined
                        ? <div className="flex md:flex-row flex-wrap flex-col">
                            <p className="text-textLight md:w-1/2 w-full dark:text-textDarkLightGray text-sm mb-3">
                        ...
                        : <div className="text-textLight md:w-1/2 w-full dark:text-textDarkLightGray text-sm mb-3">
