...
function Address() {
    return (
        <svg className="inline-flex lg:w-[15px] md:w-[15px] lg:h-[20px] md:h-[20px] w-[25px]
                                 h-[25px] mr-2" width="15" height="20" viewBox="0 0 15 20"
            fill="none" xmlns="http://www.w3.org/2000/svg">
            <path className="fill-light-red
                ...
                className="fill-light-red dark:fill-white" d="M7.34116 10C6.69217 10 6.06977 9.73661 5.61086 9.26777C5.15196 8.79893
                                 ...
                                 9.53035 8.79893 9.07145 9.26777C8.61254 9.7361 7.99014 10 7.34116 10ZM7.34116
