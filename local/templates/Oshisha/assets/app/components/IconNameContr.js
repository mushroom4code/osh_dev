        ...
        <svg width={width || '50'} height={height || "51"} viewBox="0 0 50 51" fill="none"
            ...
            <g clipPath="url(#clip0_2032_5062)">
                <rect y="0.154785" width="50" height="50.8453" rx="25"
                      className={ color ? "dark:fill-tagFilterGray fill-lightGrayBg" : "dark:fill-white fill-lightGrayBg" }/>
                <path
                    ...
                    className={ color ? "fill-white" : 'dark:fill-black fill-white'}/>
                <line x1="25.5038" y1="22.6068" x2="25.5037" y2="26.8882"
                      className={ color ? "stroke-white" : 'dark:stroke-black stroke-white'}
