...
?>
<form class="form_company form-form max-w-3xl px-8 py-10 rounded-xl bg-textDark dark:bg-darkBox mb-8 mt-5"
      id="support" enctype="multipart/form-data">
    <div class="form-form-wrap">
        <input type="hidden" name="recaptcha_token" value="">
        <?php echo bitrix_sessid_post(); ?>
        <div class="form-group mb-8">
            <label class="text-2xl font-medium dark:font-normal text-textLight dark:text-textDarkLightGray">
                Вопросы, замечания, жалобы? Свяжитесь с нами
            </label>
        </div>
