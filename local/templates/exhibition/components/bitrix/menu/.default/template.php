...
<div class="left-menu">
    ...
    <div class="personal_hide">
        ...
        <?php } ?>
        <a style="display:none;" href="/personal/support/" class="link_lk" title="Написать обращение" id="about_contacts">Поддержка</a>
        <a style="display:none;"  href="/personal/subscribe/" class="link_lk" title="Перейти в избранное" id="personal_subscribe">Избранное</a>
        <a style="display:none;" href="/personal/account/" class="link_lk" title="Подарочные сертификаты" id="personal_account">Подарочные
            сертификаты</a>
