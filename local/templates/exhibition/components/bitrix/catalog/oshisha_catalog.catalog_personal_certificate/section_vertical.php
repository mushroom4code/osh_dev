...
<div class="row mb-4 box_with_prod">
    <? if ($isFilter) : ?>
        <div class="col-lg-2 col-md-3 col-10  col-sm-4<?= (isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-sm-block' : '') ?>">
    ...
    <div class="pb-4 <?= (($isFilter) ? "col-lg-10 col-md-8 col-sm-7" : "col") ?> padding_product_box">
        <div class="row mb-4">
        ...
        <div class="sort-panel" >
            <ul class="sort-panel__view-buttons-list">
                <li class="view-buttons-list" id="bar_catalog">
                    <i class="fa fa-th-large" aria-hidden="true"></i>
                </li>
                <li class="view-buttons-list" id="line_catalog">
