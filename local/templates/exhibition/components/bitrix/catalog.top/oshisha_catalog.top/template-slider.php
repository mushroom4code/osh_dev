...
?><div id="<? echo $strContID; ?>" class=" col<? echo $arParams['LINE_ELEMENT_COUNT']; ?>">
<div class="section_slide_with_product">
<?
$boolFirst = true;
$arRowIDs = array();
...
if (1 < $intRowsCount)
{
	$arJSParams = array(
		...
		'left' => array(
			...
			'class' => 'catalog_tile_slider_arrow_left'
		),
		'right' => array(
			'id' => $strContID.'_right_arr',
			'class' => 'catalog_tile_slider_arrow_right'
		),
		'rows' => $arRowIDs,
