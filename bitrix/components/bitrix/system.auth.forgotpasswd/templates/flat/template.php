...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			<div class=" col-form-label main-profile-form-label"><?echo GetMessage("AUTH_LOGIN_EMAIL")?></div>
			<div class="">
				<input type="text" class="form-control input_lk" name="USER_LOGIN" maxlength="255" value="<?=$arResult["USER_LOGIN"]?>" />
...
<?/*if($arResult["PHONE_REGISTRATION"]):?>
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input class="form-control input_lk" type="text" name="USER_PHONE_NUMBER" maxlength="255" value="<?=$arResult["USER_PHONE_NUMBER"]?>" />
			</div>
...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="btn  link_red_button main-profile-submit" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
		</div>
