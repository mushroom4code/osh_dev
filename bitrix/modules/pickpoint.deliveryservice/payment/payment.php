...
<table class="pp_ps_table">
    <tr>
        <th><?= GetMessage('PP_POSTAMAT') ?></th>
        <th><?= GetMessage('PP_VALUE') ?></th>
    </tr>
    <tr>
        <td><?= GetMessage('PP_POSTAMAT_ID') ?></td>
        <td><?= $arData['POSTAMAT_ID'] ?></td>
    </tr>
    <tr>
        <td><?= GetMessage('PP_ADDRESS') ?></td>
        <td><?= $arData['ADDRESS'] ?></td>
    </tr>
    <tr>
        <td><?= GetMessage('PP_NAME') ?></td>
        <td><?= $arData['NAME'] ?></td>
    </tr>
</table>
