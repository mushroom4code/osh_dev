 ...
 * Created by Mebiys
 */
function pickpoint_deliveryservice_adminInterface(params){
    ...
    this.popup = function (code,info,basement){
		...
		var LEFT = (typeof(basement) !== 'undefined') ? $(basement).offset().left : $(info).offset().left;	
        
		LEFT -= parseInt(obj.width()/2);		
        obj.css({
            top: (offset+15)+'px',
            left: LEFT,
            display: 'block'
