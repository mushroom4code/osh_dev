...
class CAllPickpoint
{
    protected static $moduleId = 'pickpoint.deliveryservice';

    public static function SelectCityByPPID($iPPID)
    {
        global $DB;
    ...
    public static function SelectCityByBXID($iBXID)
    {
        global $DB;
    ...
    public static function SelectZoneByID($zoneID)
    {
        global $DB;
    ...
    public static function SetPPCity($iPPID, $arFields)
    {
        global $DB;
    ...
    public static function SetPPZone($zoneID, $arFields)
    {
        global $DB;
    ...
    public static function AddOrderPostamat($arFields)
    {
        global $DB;
    ...
    public static function SelectOrderPostamat($iOrderID = 0)
    {
        global $DB;

        return $DB->Query(
            'SELECT * FROM `b_pp_order_postamat`'
            .((intval($iOrderID) > 0)
    ...
    public static function SetOrderInvoice($iOrderID = 0, $invoiceId = 0)
    {
        global $DB;
    ...
    public static function SetOrderSettings($iOrderID = 0, $options = '')
    {
        global $DB;
    ...
    public static function DeleteCities($arIDs = array())
    {
        global $DB;
        $sIN = implode(',', $arIDs);
