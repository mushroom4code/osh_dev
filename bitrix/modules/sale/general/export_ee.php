...
final class ExportOneCCRMEe extends CSaleExportEe
{
...
class CSaleExportEe
{
    ...
    {
        return CSaleExportEe::getTagName("SALE_EXPORT_SHEM_VERSION") . "=\"" . self::getVersionSchema() . "\" " . CSaleExportEe::getTagName("SALE_EXPORT_SHEM_DATE_CREATE") . "=\"" . date("Y-m-d") . "T" . date("G:i:s") . "\" " . CSaleExportEe::getTagName("SALE_EXPORT_DATE_FORMAT") . "=\"" . CSaleExportEe::getTagName("SALE_EXPORT_DATE_FORMAT_DF") . "=yyyy-MM-dd; " . CSaleExportEe::getTagName("SALE_EXPORT_DATE_FORMAT_DLF") . "=DT\" " . CSaleExportEe::getTagName("SALE_EXPORT_DATE_FORMAT_DATETIME") . "=\"" . CSaleExportEe::getTagName("SALE_EXPORT_DATE_FORMAT_DF") . "=" . CSaleExportEe::getTagName("SALE_EXPORT_DATE_FORMAT_TIME") . "; " . CSaleExportEe::getTagName("SALE_EXPORT_DATE_FORMAT_DLF") . "=T\" " . CSaleExportEe::getTagName("SALE_EXPORT_DEL_DT") . "=\"T\" " . CSaleExportEe::getTagName("SALE_EXPORT_FORM_SUMM") . "=\"" . CSaleExportEe::getTagName("SALE_EXPORT_FORM_CC") . "=18; " . CSaleExportEe::getTagName("SALE_EXPORT_FORM_CDC") . "=2; " . CSaleExportEe::getTagName("SALE_EXPORT_FORM_CRD") . "=.\" " . CSaleExportEe::getTagName("SALE_EXPORT_FORM_QUANT") . "=\"" . CSaleExportEe::getTagName("SALE_EXPORT_FORM_CC") . "=18; " . CSaleExportEe::getTagName("SALE_EXPORT_FORM_CDC") . "=2; " . CSaleExportEe::getTagName("SALE_EXPORT_FORM_CRD") . "=.\"";
    }
    ...
    static function getOrderDeliveryItem($arOrder, $bVat, $vatRate, $vatSum)
    {
        if (floatval($arOrder["PRICE_DELIVERY"]) <= 0)
            return;
        ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>ORDER_DELIVERY</<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ORDER_DELIVERY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <?
        if (self::getVersionSchema() > self::DEFAULT_VERSION) {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_UNIT") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>>796</<?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME_UNIT") ?>><?= htmlspecialcharsbx(self::$measures[796]['MEASURE_TITLE']) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME_UNIT") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_UNIT") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_KOEF") ?>>1</<?= CSaleExportEe::getTagName("SALE_EXPORT_KOEF") ?>>
            <?
        } else {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_BASE_UNIT") ?> <?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>="796" <?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME_UNIT") ?>="<?= CSaleExportEe::getTagName("SALE_EXPORT_SHTUKA") ?>" <?= CSaleExportEe::getTagName("SALE_EXPORT_INTERNATIONAL_ABR") ?>="<?= CSaleExportEe::getTagName("SALE_EXPORT_RCE") ?>"><?= CSaleExportEe::getTagName("SALE_EXPORT_SHT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_BASE_UNIT") ?>>
            <?
        }
        ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PRICE_PER_ITEM") ?>><?= $arOrder["PRICE_DELIVERY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_PRICE_PER_ITEM") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_QUANTITY") ?>>1</<?= CSaleExportEe::getTagName("SALE_EXPORT_QUANTITY") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $arOrder["PRICE_DELIVERY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTIES_VALUES") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE_NOMENKLATURA") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SERVICE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE_OF_NOMENKLATURA") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SERVICE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTIES_VALUES") ?>>
        <? if ($bVat) {
        ...
        if (self::$orderTax > $vatSum && self::$orderTax == roundEx($vatSum + $deliveryTax, 2)) {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX_RATES") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX_RATE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_VAT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_RATE") ?>><?= $vatRate * 100 ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_RATE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX_RATE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX_RATES") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_TAXES") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_VAT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") ?>>true</<?= CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $deliveryTax ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAXES") ?>>
            <?
        }
    ...
    static function getCatalogMeasure()
    {
        ...
        if (empty($arMeasures))
            $arMeasures[796] = array('NAME' => CSaleExportEe::getTagName("SALE_EXPORT_SHTUKA"));
    ...
    static function prepareSalePropertyRekv(\Bitrix\Sale\IBusinessValueProvider $entity, $agentParams, $arProp, $locationStreetPropertyValue = '')
    {
        ...
        foreach ($agentParams as $k => $v) {
            if (mb_strpos($k, "REKV_") !== false) {//params
                if (!is_array($v)) {
                    $agent["REKV"][$k] = $v;
                } else {
                    if ($v["TYPE"] == '')
    ...
    static function ExportOrders2Xml($arFilter = array(), $nTopCount = 0, $currency = "", $crmMode = false, $time_limit = 0, $version = false, $arOptions = array())
    {
        ...
        while ($arOrder = $dbOrderList->Fetch()) {
            ...
            $arOrderTax = CSaleExportEe::getOrderTax($order);
            ...
            if (self::getVersionSchema() >= self::CONTAINER_VERSION) {
                ob_start();
                echo '<' . CSaleExportEe::getTagName("SALE_EXPORT_CONTAINER") . '>';
            }
    ...
    static function getXmlOrderTax($arOrderTaxAll)
    {
        ...
        if (is_array($arOrderTaxAll) && count($arOrderTaxAll) > 0) {
            $orderTax = 0;
            $strResult .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_TAXES") . ">";
            foreach ($arOrderTaxAll as $arOrderTax) {
                $arOrderTax["VALUE_MONEY"] = roundEx($arOrderTax["VALUE_MONEY"], 2);
                $orderTax += $arOrderTax["VALUE_MONEY"];

                $strResult .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_TAX") . ">" .
                    "<" . CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") . ">" . htmlspecialcharsbx($arOrderTax["TAX_NAME"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") . ">" .
                    "<" . CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") . ">" . (($arOrderTax["IS_IN_PRICE"] == "Y") ? "true" : "false") . "</" . CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") . ">" .
                    "<" . CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") . ">" . $arOrderTax["VALUE_MONEY"] . "</" . CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") . ">" .
                    "</" . CSaleExportEe::getTagName("SALE_EXPORT_TAX") . ">";
            }
            $strResult .= "</" . CSaleExportEe::getTagName("SALE_EXPORT_TAXES") . ">";
        }
    ...
    static function getXmlOrderDiscount($arOrder)
    {
        ...
        if (DoubleVal($arOrder["DISCOUNT_VALUE"]) > 0) {
            $strResult = "<" . CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNTS") . ">
						<" . CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNT") . ">
							<" . CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") . ">" . CSaleExportEe::getTagName("SALE_EXPORT_ORDER_DISCOUNT") . "</" . CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") . ">
							<" . CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") . ">" . $arOrder["DISCOUNT_VALUE"] . "</" . CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") . ">
							<" . CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") . ">false</" . CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") . ">
						</" . CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNT") . ">
					</" . CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNTS") . ">";
        }
        return $strResult;
    }
    ...
    static function getXmlSaleStore($arShipmentStore, $arStore)
    {
        ...
        if (count($arShipmentStore) > 0) {
            ...
            foreach ($arShipmentStore as $shipmentStoreId) {
                if (intval($shipmentStoreId) > 0 && !empty($arStore[$shipmentStoreId])) {
                    ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_STORY") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= $arStore[$shipmentStoreId]["XML_ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= htmlspecialcharsbx($arStore[$shipmentStoreId]["TITLE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>

                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>><?= htmlspecialcharsbx($arStore[$shipmentStoreId]["ADDRESS"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>>
                    ...
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arStore[$shipmentStoreId]["ADDRESS"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS") ?>>

                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACTS") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= (self::getVersionSchema() > self::DEFAULT_VERSION ? CSaleExportEe::getTagName("SALE_EXPORT_WORK_PHONE_NEW") : CSaleExportEe::getTagName("SALE_EXPORT_WORK_PHONE")) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arStore[$shipmentStoreId]["PHONE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACTS") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_STORY") ?>>
                    <?
        ...
        if ($bufer <> '')
            $bufer = "<" . CSaleExportEe::getTagName("SALE_EXPORT_STORIES") . ">" . $bufer . "</" . CSaleExportEe::getTagName("SALE_EXPORT_STORIES") . ">";
    ...
    function getXmlSaleStoreBasket($arOrder, $arStore)
    {
        ob_start();
        $storeBasket = "
			<" . CSaleExportEe::getTagName("SALE_EXPORT_STORIES") . ">
				<" . CSaleExportEe::getTagName("SALE_EXPORT_STORY") . ">
					<" . CSaleExportEe::getTagName("SALE_EXPORT_ID") . ">" . $arStore[$arOrder["STORE_ID"]]["XML_ID"] . "</" . CSaleExportEe::getTagName("SALE_EXPORT_ID") . ">
					<" . CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") . ">" . htmlspecialcharsbx($arStore[$arOrder["STORE_ID"]]["TITLE"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") . ">
				</" . CSaleExportEe::getTagName("SALE_EXPORT_STORY") . ">
			</" . CSaleExportEe::getTagName("SALE_EXPORT_STORIES") . ">
			";
        //$bufer = ob_get_clean();
    ...
    {
        ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_MARKING_CODE_GROUP") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>><?= $arBasket["MARKING_CODE_GROUP"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_MARKING_CODE_GROUP") ?>>
        <?
    }
    ...
    protected static function outputXmlUnit($arBasket)
    {
        if (self::getVersionSchema() > self::DEFAULT_VERSION) {
            ...
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_UNIT") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>><?= $arBasket["MEASURE_CODE"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME_UNIT") ?>><?= htmlspecialcharsbx(self::$measures[$arBasket["MEASURE_CODE"]]['MEASURE_TITLE']) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME_UNIT") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_UNIT") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_KOEF") ?>>1</<?= CSaleExportEe::getTagName("SALE_EXPORT_KOEF") ?>>
            <?
        } else {
            if ($arBasket["MEASURE_CODE"] == 796) {
                ...
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_BASE_UNIT") ?> <?= CSaleExportEe::getTagName("SALE_EXPORT_CODE") ?>="<?= $arBasket["MEASURE_CODE"] ?>" <?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME_UNIT") ?>="<?= htmlspecialcharsbx(self::$measures[$arBasket["MEASURE_CODE"]]['MEASURE_TITLE']) ?>" <?= CSaleExportEe::getTagName("SALE_EXPORT_INTERNATIONAL_ABR") ?>="<?= self::$measures[$arBasket["MEASURE_CODE"]]["SYMBOL_LETTER_INTL"] ?>"><?= self::$measures[$arBasket["MEASURE_CODE"]]["SYMBOL_RUS"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_BASE_UNIT") ?>>
                <?
            }
    ...
    static function getXmlBasketItems($type, $arOrder, $arFilter, $arSelect = array(), $arShipment = array(), $order = null)
    {
        ...
        ob_start();
        ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEMS") ?>><?


        // Enterego
        $select = array("ID", 'PRICE_TYPE_ID', "NOTES", "PRODUCT_XML_ID", "CATALOG_XML_ID", "NAME", "PRICE", "QUANTITY",
            "DISCOUNT_PRICE", "VAT_RATE", "MEASURE_CODE", "SET_PARENT_ID", "TYPE", "VAT_INCLUDED", "MARKING_CODE_GROUP");
        ...
        while ($arBasket = $dbBasket->fetch()) {
            ...
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= htmlspecialcharsbx(static::normalizeExternalCode($arBasket["PRODUCT_XML_ID"])) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_CATALOG_ID") ?>><?= htmlspecialcharsbx($arBasket["CATALOG_XML_ID"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_CATALOG_ID") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= htmlspecialcharsbx($arBasket["NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <?
            ...
            if (DoubleVal($arBasket["DISCOUNT_PRICE"]) > 0) {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNTS") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNT") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_DISCOUNT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $arBasket["DISCOUNT_PRICE"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") ?>>true</<?= CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNT") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_DISCOUNTS") ?>>
                <?
            ...
            <? if (self::getVersionSchema() >= self::PARTIAL_VERSION && $type == 'Shipment') {
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PRICE_PER_ITEM") ?>><?= $arBasket["PRICE"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_PRICE_PER_ITEM") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_QUANTITY") ?>><?= $arBasket["SALE_INTERNALS_BASKET_SHIPMENT_ITEM_QUANTITY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_QUANTITY") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $arBasket["PRICE"] * $arBasket["SALE_INTERNALS_BASKET_SHIPMENT_ITEM_QUANTITY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
                <?
            } else {
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PRICE_PER_ITEM") ?>><?= $arBasket["PRICE"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_PRICE_PER_ITEM") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_QUANTITY") ?>><?= $arBasket["QUANTITY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_QUANTITY") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $arBasket["PRICE"] * $arBasket["QUANTITY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
                <?
            } ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTIES_VALUES") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE_NOMENKLATURA") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            ...
            if ($arPrice):
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE_PRICE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $arPrice['XML_ID'] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <?php endif;
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            ...
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_BASKET_NUMBER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $number ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <?
            ...
            while ($arPropBasket = $dbProp->Fetch()) {
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE_BASKET") ?>#<?= ($arPropBasket["CODE"] != "" ? $arPropBasket["CODE"] : htmlspecialcharsbx($arPropBasket["NAME"])) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arPropBasket["VALUE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                <?
            }
            ?>
            ...
            <? if (DoubleVal($arBasket["VAT_RATE"]) > 0) {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX_RATE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_VAT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_RATE") ?>><?= $arBasket["VAT_RATE"] * 100 ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_RATE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX_RATE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX_RATES") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TAXES") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_VAT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") ?>><?= $arBasket["VAT_INCLUDED"] == "Y" ? 'true' : 'false' ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_IN_PRICE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= roundEx($basketVatSum, 2) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAX") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_TAXES") ?>>
                <?
            }
    ...
    static function getXmlSaleProperties($arOrder, $arShipment, $arPayment, $agent, $agentParams, $bExportFromCrm)
    {
        ...
        if ($arOrder["DATE_PAYED"] <> '') {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DATE_PAID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $arOrder["DATE_PAYED"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <?
        }
        ...
        if (self::getVersionSchema() < self::PARTIAL_VERSION || $bExportFromCrm) // #version# < 2.10      ? || $bExportFromCrm
        {
            if ($arPayment["PAY_VOUCHER_NUM"] <> '') {
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PAY_NUMBER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arPayment["PAY_VOUCHER_NUM"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                <?
            }
            if ($arShipment["DATE_ALLOW_DELIVERY"] <> '') {
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DATE_ALLOW_DELIVERY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $arShipment["DATE_ALLOW_DELIVERY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                <?
            }
        } else {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DATE_ALLOW_DELIVERY_LAST") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $arOrder["DATE_ALLOW_DELIVERY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>><?
        ...
        if ($arShipment["DELIVERY_ID"] <> '') {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DELIVERY_SERVICE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arShipment["DELIVERY_NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= GetMessage("SALE_EXPORT_DELIVERY_ID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arShipment["DELIVERY_ID"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <?
        }
        ...
        if (intval($arPayment["PAY_SYSTEM_ID"]) > 0) {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PAY_SYSTEM") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arPayment["PAY_SYSTEM_NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= GetMessage("SALE_EXPORT_PAY_SYSTEM_ID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arPayment["PAY_SYSTEM_ID"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <?
        }
        ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ORDER_PAID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($arOrder["PAYED"] == "Y") ? "true" : "false"; ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <?
        if (self::getVersionSchema() < self::PARTIAL_VERSION || $bExportFromCrm) {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ALLOW_DELIVERY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($arShipment["ALLOW_DELIVERY"] == "Y") ? "true" : "false"; ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>><?
        }
        ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_CANCELED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($arOrder["CANCELED"] == "Y") ? "true" : "false"; ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_FINAL_STATUS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($arOrder["STATUS_ID"] == "F") ? "true" : "false"; ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ORDER_STATUS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><? $arStatus = static::getStatusInfoByStatusId($arOrder["STATUS_ID"]);
        echo htmlspecialcharsbx("[" . $arOrder["STATUS_ID"] . "] " . $arStatus["NAME"]); ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= GetMessage("SALE_EXPORT_ORDER_STATUS_ID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arOrder["STATUS_ID"]); ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <? if ($arOrder["DATE_CANCELED"] <> '') {
        ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= GetMessage("SALE_EXPORT_DATE_CANCEL") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $arOrder["DATE_CANCELED"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= GetMessage("SALE_EXPORT_CANCEL_REASON") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arOrder["REASON_CANCELED"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <?
    }
        if ($arOrder["DATE_STATUS"] <> '') {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DATE_STATUS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $arOrder["DATE_STATUS"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <?
        }
        if ($arOrder["USER_DESCRIPTION"] <> '') {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_USER_DESCRIPTION") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($arOrder["USER_DESCRIPTION"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <?
        }
        ...
        if (!empty($agent["REKV"])) {
            foreach ($agent["REKV"] as $k => $v) {
                if ($agentParams[$k]["NAME"] <> '' && $v <> '') {
                    ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= htmlspecialcharsbx($agentParams[$k]["NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($v) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <?
                }
            }
    ...
    static function OutputXmlSiteName($arOrder)
    {
        ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SITE_NAME") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>[<?= $arOrder["LID"] ?>] <?= htmlspecialcharsbx(self::$siteNameByOrder) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
        <?
    }
    ...
    static function OutputXmlDeliveryAddress()
    {
        if (self::getDeliveryAddress() <> '') {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= GetMessage("SALE_EXPORT_DELIVERY_ADDRESS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx(self::getDeliveryAddress()) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
            ...
            case 'Shipment':
                if ($document['ID'] > 0) {
                    ...
                    while ($resultChange = $result->fetch()) {
                        ?>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_DOCUMENT") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= $resultChange["ENTITY_ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER") ?>><?= $resultChange["ENTITY_ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>><?= $DB->FormatDate($resultChange["DATE_CREATE"], CSite::GetDateFormat("FULL"), "YYYY-MM-DD") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_SHIPMENT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SELLER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY") ?>><?= htmlspecialcharsbx(substr($document["CURRENCY"], 0, 3)) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER_BASE") ?>><?= $resultChange['ORDER_ID'] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER_BASE") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_REMOVED") ?>>true</<?= CSaleExportEe::getTagName("SALE_EXPORT_REMOVED") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTIES_VALUES") ?>></<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTIES_VALUES") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTRAGENTS") ?>></<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTRAGENTS") ?>>
    ...
    static function OutputXmlDocument($typeDocument, $xmlResult, $document = array())
    {
        ...
        switch ($typeDocument) {
            case 'Order':
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= $document["ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER") ?>><?= self::getAccountNumberShopPrefix(); ?><?= $document["ACCOUNT_NUMBER"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>><?= $DB->FormatDate($document["DATE_INSERT_FORMAT"], CSite::GetDateFormat("FULL"), "YYYY-MM-DD") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_ORDER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SELLER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY") ?>><?= htmlspecialcharsbx(((strlen(self::$currency) > 0) ? substr(self::$currency, 0, 3) : substr($document["CURRENCY"], 0, 3))) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY_RATE") ?>>1</<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY_RATE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $document["PRICE"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
                ...
                if (self::getVersionSchema() > self::DEFAULT_VERSION) {
                    ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VERSION") ?>><?= (intval($document["VERSION"]) > 0 ? $document["VERSION"] : 0) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VERSION") ?>><?
                    if ($document["ID_1C"] <> '') {
                        ?>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID_1C") ?>><?= htmlspecialcharsbx($document["ID_1C"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID_1C") ?>><?
                    }
                }
                if (self::$crmMode) {
                    ?>
                ...
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME") ?>><?= $DB->FormatDate($document["DATE_INSERT_FORMAT"], CSite::GetDateFormat("FULL"), "HH:MI:SS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_COMMENTS") ?>><?= htmlspecialcharsbx(self::toText($document["COMMENTS"])) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_COMMENTS") ?>>
            ...
            case 'Shipment':
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= ($document["ID_1C"] <> '' ? $document["ID_1C"] : $document["ID"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER") ?>><?= $document["ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER") ?>>
                <? switch ($typeDocument) {
                case 'Payment':
                    ?>

                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>><?= $DB->FormatDate($document["DATE_BILL"], CSite::GetDateFormat("FULL"), "YYYY-MM-DD") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_PAYMENT_" . \Bitrix\Sale\PaySystem\Manager::getPsType($document['PAY_SYSTEM_ID'])) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>>
                    <? break;
                case 'Shipment':
                    ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>><?= $DB->FormatDate($document["DATE_INSERT"], CSite::GetDateFormat("FULL"), "YYYY-MM-DD") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_DATE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_SHIPMENT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_HOZ_OPERATION") ?>>
                    <? break;
            } ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SELLER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY") ?>><?= htmlspecialcharsbx(((self::$currency <> '') ? mb_substr(self::$currency, 0, 3) : mb_substr($document["CURRENCY"], 0, 3))) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY_RATE") ?>>1</<?= CSaleExportEe::getTagName("SALE_EXPORT_CURRENCY_RATE") ?>>
                <? switch ($typeDocument) {
                case 'Payment':
                    ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $document['SUM'] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
                    <? break;
                case 'Shipment':
                    $price = 0;
                    ...
                    ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>><?= $price + intval($document['PRICE_DELIVERY']) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_AMOUNT") ?>>
                    <? break;
            } ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VERSION") ?>><?= (intval($document["VERSION"]) > 0 ? $document["VERSION"] : 0) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VERSION") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER_BASE") ?>><?= $document['ORDER_ID'] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_NUMBER_BASE") ?>>
                <? echo $xmlResult['Contragents']; ?>
                <? switch ($typeDocument) {
                case 'Payment':
                    ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME") ?>><?= $DB->FormatDate($document["DATE_BILL"], CSite::GetDateFormat("FULL"), "HH:MI:SS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME") ?>>
                    <? break;
                case 'Shipment':
                    ?>
                    <?= $xmlResult['OrderTax']; ?>
                    ...
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME") ?>><?= $DB->FormatDate($document["DATE_INSERT"], CSite::GetDateFormat("FULL"), "HH:MI:SS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME") ?>>
                    <? break;
            } ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_COMMENTS") ?>><?= htmlspecialcharsbx($document["COMMENTS"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_COMMENTS") ?>>
                ...
                case 'Payment':
                    ...
                    if ($checkData) {
                        ?>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_CASHBOX_CHECKS") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_CASHBOX_CHECK") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= ($checkData['ID']) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROP_VALUES") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROP_VALUE") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>PRINT_CHECK</<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>true</<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROP_VALUE") ?>>
                        </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROP_VALUES") ?>>
                        </<?= CSaleExportEe::getTagName("SALE_EXPORT_CASHBOX_CHECK") ?>>
                        </<?= CSaleExportEe::getTagName("SALE_EXPORT_CASHBOX_CHECKS") ?>>
                    ...
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DATE_PAID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["DATE_PAID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_CANCELED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($document["CANCELED"] == 'Y' ? 'true' : 'false') ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PAY_SYSTEM_ID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["PAY_SYSTEM_ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PAY_SYSTEM") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["PAY_SYSTEM_NAME"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PAY_PAID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($document["PAID"] == 'Y' ? 'true' : 'false') ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PAY_RETURN") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($document["IS_RETURN"] == 'Y' ? 'true' : 'false') ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PAY_RETURN_REASON") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["PAY_RETURN_COMMENT"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                ...
                case 'Shipment':
                    ...
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTIES_VALUES") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_PRICE_DELIVERY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= (strlen($document["PRICE_DELIVERY"]) > 0 ? $document["PRICE_DELIVERY"] : "0.0000") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DATE_ALLOW_DELIVERY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["DATE_ALLOW_DELIVERY"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DELIVERY_LOCATION") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["DELIVERY_LOCATION"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DELIVERY_STATUS") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["STATUS_ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DELIVERY_DEDUCTED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($document["DEDUCTED"] == 'Y' ? 'true' : 'false') ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DATE_DEDUCTED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["DATE_DEDUCTED"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_REASON_UNDO_DEDUCTED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["REASON_UNDO_DEDUCTED"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_RESERVED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($document["RESERVED"] == 'Y' ? 'true' : 'false') ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DELIVERY_ID") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["DELIVERY_ID"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DELIVERY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["DELIVERY_NAME"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_CANCELED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= ($document["CANCELED"] == 'Y' ? 'true' : 'false') ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    ...
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_DELIVERY_DATE_CANCEL") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["DATE_CANCELED"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= GetMessage("SALE_EXPORT_CANCEL_REASON") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["REASON_CANCELED"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_REASON_MARKED") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["REASON_MARKED"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_TRACKING_NUMBER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= $document["TRACKING_NUMBER"] ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_PROPERTY_VALUE") ?>>
    ...
    static function ExportContragents($arOrder = array(), $arProp = array(), $agent = array(), $arOptions = array())
    {
        ...
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= $xmlId ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>

        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= htmlspecialcharsbx($agent["AGENT_NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
        <?
        ...
        if ($agent["ADDRESS_FULL"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") . ">" . htmlspecialcharsbx($agent["ADDRESS_FULL"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") . ">";
        } else {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") . "></" . CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") . ">";
        }
        if ($agent["INDEX"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["INDEX"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["COUNTRY"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
									...
									<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["COUNTRY"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
								</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["REGION"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["REGION"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["STATE"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["STATE"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["TOWN"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["TOWN"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["CITY"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["CITY"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["STREET"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								<" . CSaleExportEe::getTagName("SALE_EXPORT_TYPE") . ">" . CSaleExportEe::getTagName("SALE_EXPORT_STREET") . "</" . CSaleExportEe::getTagName("SALE_EXPORT_TYPE") . ">
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["STREET"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["HOUSE"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["HOUSE"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["BUILDING"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["BUILDING"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        if ($agent["FLAT"] <> '') {
            $address .= "<" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">
								...
								<" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">" . htmlspecialcharsbx($agent["FLAT"]) . "</" . CSaleExportEe::getTagName("SALE_EXPORT_VALUE") . ">
							</" . CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") . ">";
        }
        //endregion
        ...
        if ($agent["IS_FIZ"] == "Y") {
            ...
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME") ?>><?= htmlspecialcharsbx($agent["FULL_NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME") ?>>
            <?
            if ($agent["SURNAME"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_SURNAME") ?>><?= htmlspecialcharsbx($agent["SURNAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_SURNAME") ?>><?
            }
            if ($agent["NAME"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_NAME") ?>><?= htmlspecialcharsbx($agent["NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_NAME") ?>><?
            }
            if ($agent["SECOND_NAME"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_MIDDLE_NAME") ?>><?= htmlspecialcharsbx($agent["SECOND_NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_MIDDLE_NAME") ?>><?
            }
            if ($agent["BIRTHDAY"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_BIRTHDAY") ?>><?= htmlspecialcharsbx($agent["BIRTHDAY"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_BIRTHDAY") ?>><?
            }
            if ($agent["MALE"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_SEX") ?>><?= htmlspecialcharsbx($agent["MALE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_SEX") ?>><?
            }
            if ($agent["INN"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_INN") ?>><?= htmlspecialcharsbx($agent["INN"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_INN") ?>><?
            }
            if ($agent["KPP"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_KPP") ?>><?= htmlspecialcharsbx($agent["KPP"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_KPP") ?>><?
            }
            if ($address <> '') {
            ...
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_OFICIAL_NAME") ?>><?= htmlspecialcharsbx($agent["FULL_NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_OFICIAL_NAME") ?>>
            <?
            if ($address <> '') {
            ...
            if ($agent["EGRPO"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_EGRPO") ?>><?= htmlspecialcharsbx($agent["EGRPO"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_EGRPO") ?>><?
            }
            if ($agent["OKVED"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_OKVED") ?>><?= htmlspecialcharsbx($agent["OKVED"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_OKVED") ?>><?
            }
            if ($agent["OKDP"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_OKDP") ?>><?= htmlspecialcharsbx($agent["OKDP"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_OKDP") ?>><?
            }
            if ($agent["OKOPF"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_OKOPF") ?>><?= htmlspecialcharsbx($agent["OKOPF"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_OKOPF") ?>><?
            }
            if ($agent["OKFC"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_OKFC") ?>><?= htmlspecialcharsbx($agent["OKFC"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_OKFC") ?>><?
            }
            if ($agent["OKPO"] <> '') {
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_OKPO") ?>><?= htmlspecialcharsbx($agent["OKPO"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_OKPO") ?>><?
                ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_OKPO_CODE") ?>><?= htmlspecialcharsbx($agent["OKPO"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_OKPO_CODE") ?>><?
            }
            if ($agent["ACCOUNT_NUMBER"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ACCOUNT_NUMBER") ?>><?= htmlspecialcharsbx($agent["ACCOUNT_NUMBER"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ACCOUNT_NUMBER") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_BANK") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= htmlspecialcharsbx($agent["B_NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>><?= htmlspecialcharsbx($agent["B_ADDRESS_FULL"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>>
                <?
                if ($agent["B_INDEX"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_POST_CODE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_INDEX"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_COUNTRY"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_COUNTRY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_COUNTRY"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_REGION"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_REGION") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_REGION"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_STATE"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_STATE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_STATE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if (strlen($agent["B_TOWN"]) > 0) {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SMALL_CITY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_TOWN"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_CITY"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_CITY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_CITY"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_STREET"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_STREET") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_STREET"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_HOUSE"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_HOUSE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_HOUSE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_BUILDING"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_BUILDING") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_BUILDING"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                if ($agent["B_FLAT"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_FLAT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["B_FLAT"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>><?
                }
                ?>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS") ?>>
                <?
                if ($agent["B_BIK"] <> '') {
                    ?><<?= CSaleExportEe::getTagName("SALE_EXPORT_BIC") ?>><?= htmlspecialcharsbx($agent["B_BIK"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_BIC") ?>><?
                }
                ?>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_BANK") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_MONEY_ACCOUNT") ?>>
        ...
        if ($agent["F_ADDRESS_FULL"] <> '') {
            ...
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>><?= htmlspecialcharsbx($agent["F_ADDRESS_FULL"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>>
            <?
            if ($agent["F_INDEX"] <> '') {
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_POST_CODE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_INDEX"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            if ($agent["F_COUNTRY"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_COUNTRY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_COUNTRY"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            if ($agent["F_REGION"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_REGION") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_REGION"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            if ($agent["F_STATE"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_STATE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_STATE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            if ($agent["F_TOWN"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_SMALL_CITY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_TOWN"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            if ($agent["F_CITY"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_CITY") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_CITY"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            if ($agent["F_STREET"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_STREET") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_STREET"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            if ($agent["F_HOUSE"] <> '') {
            ...
            if ($agent["F_FLAT"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_FLAT") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["F_FLAT"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <?
            }
            ?>
        ...
        if ($agent["PHONE"] <> '' || $agent["EMAIL"] <> '') {
            ...
            if ($agent["PHONE"] <> '') {
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= (self::getVersionSchema() > self::DEFAULT_VERSION ? CSaleExportEe::getTagName("SALE_EXPORT_WORK_PHONE_NEW") : CSaleExportEe::getTagName("SALE_EXPORT_WORK_PHONE")) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["PHONE"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                <?
            }
            if (strlen($agent["EMAIL"]) > 0) {
                ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= (self::getVersionSchema() > self::DEFAULT_VERSION ? CSaleExportEe::getTagName("SALE_EXPORT_MAIL_NEW") : CSaleExportEe::getTagName("SALE_EXPORT_MAIL")) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($agent["EMAIL"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                <?
            }
            ?>
        ...
        if ($agent["CONTACT_PERSON"] <> '') {
            ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_REPRESENTATIVES") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_REPRESENTATIVE") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTRAGENT") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_RELATION") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT_PERSON") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_RELATION") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= md5($agent["CONTACT_PERSON"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>><?= htmlspecialcharsbx($agent["CONTACT_PERSON"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ITEM_NAME") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTRAGENT") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_REPRESENTATIVE") ?>>
            </<?= CSaleExportEe::getTagName("SALE_EXPORT_REPRESENTATIVES") ?>>
            <?
        } ?>
        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_BUYER") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ROLE") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTRAGENT") ?>>
        </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTRAGENTS") ?>>
        <?
    ...
    <?php }
        if (!empty($arData['COMPANY'])) { ?>
            <<?= CSaleExportEe::getTagName("SALE_EXPORT_COMPANYS") ?>>
            <?php foreach ($arData['COMPANY'] as $company) { ?>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_COMPANY") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= htmlspecialcharsbx($company["COMPANY_ID"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME") ?>><?= htmlspecialcharsbx($company["NAME"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_FULL_NAME") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>><?= htmlspecialcharsbx($company["ADDRESS"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_PRESENTATION") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_POST_CODE") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_ADDRESS_FIELD") ?>>
                ...
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACTS") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>><?= CSaleExportEe::getTagName("SALE_EXPORT_WORK_PHONE_NEW") ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TYPE") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>><?= htmlspecialcharsbx($company["PHONE"])?></<?= CSaleExportEe::getTagName("SALE_EXPORT_VALUE") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACT") ?>>
                </<?= CSaleExportEe::getTagName("SALE_EXPORT_CONTACTS") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME_COMPANY") ?>><?= htmlspecialcharsbx($company["TIMES"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_TIME_COMPANY") ?>>
                <<?= CSaleExportEe::getTagName("SALE_EXPORT_COMPANY_ARCHIVED") ?>><?= htmlspecialcharsbx($company["ARCHIVED"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_COMPANY_ARCHIVED") ?>>
                <?php if (!empty($arData['COMPANY'][$company["COMPANY_ID"]]['CONTRAGENTS'])) { ?>
                    <<?= CSaleExportEe::getTagName("SALE_EXPORT_USER_CONTRAGENTS") ?>>
                    <?php foreach ($arData['COMPANY'][$company["COMPANY_ID"]]['CONTRAGENTS'] as $contrUser => $result_param) { ?>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_USER_CONTRAGENT") ?>>
                        <<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>><?= htmlspecialcharsbx($result_param["CONTR_AGENT_ID"]) ?></<?= CSaleExportEe::getTagName("SALE_EXPORT_ID") ?>>
                        </<?= CSaleExportEe::getTagName("SALE_EXPORT_USER_CONTRAGENT") ?>>
                    <?php } ?>
                    </<?= CSaleExportEe::getTagName("SALE_EXPORT_USER_CONTRAGENTS") ?>>
                <?php } ?>
...
<?php
                ...
                foreach ($codes as $codeKey => $code) {
                    if ($mapping = BusinessValue::getMapping($codeKey, BusinessValueConsumer1C::CONSUMER_KEY, $personTypeId, array('GET_VALUE' => array('PROPERTY' => 'BY_ID')))) {
                        ...
                        switch ($mapping['PROVIDER_KEY']) {
                            ...
                            default:
                                continue 2; // other types aren't present in old version
                        }
        ...
        foreach ($map1C as $codeKey1C => $mapping1C) {
            if ($codeKey1C && is_array($mapping1C)) {
                ...
                switch ($mapping1C['TYPE']) {
                    ...
                    default:
                        continue 2; // other types should not be there
                }
    ...
    public static function getTagName($name)
    {
        ...
        if (empty($lang[static::$lid])) {
            $lang[static::$lid] = \Bitrix\Main\Localization\Loc::loadLanguageFile($_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/sale/general/export_ee.php', static::$lid);
        }
