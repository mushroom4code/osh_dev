						...
						<?foreach($arPriceChange as $arPriceChangeItem):?>
							<tr>
								<td data-role="change_price_value">
									<input name="<?=$this->getInputName('change_price_value', true);?>" type="text" placeholder="+10%" 
								...
								<td data-role="change_price_min">
									<input name="<?=$this->getInputName('change_price_min', true);?>" type="text" placeholder="100" 
								...
								<td data-role="change_price_max">
									<input name="<?=$this->getInputName('change_price_max', true);?>" type="text" placeholder="1000" 
