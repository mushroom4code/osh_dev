...
<div class="plugin-form__fields-group" data-role="mode_settings" data-code="simple" style="display:none;">
	...
	<div class="plugin-form__field">
		...
		<div class="plugin-form__field-value">
			<input type="text" name="<?=$this->getInputName('simple_search');?>"
				value="<?=htmlspecialcharsbx($this->get('simple_search'));?>" size="40" data-role="simple_search" />
		</div>
	</div>
	<?//?>
	<div class="plugin-form__field">
...
<div class="plugin-form__fields-group" data-role="mode_settings" data-code="reg_exp" style="display:none;">
	...
	<div class="plugin-form__field">
		...
		<div class="plugin-form__field-value">
			<input type="text" name="<?=$this->getInputName('reg_exp_search');?>"
				value="<?=htmlspecialcharsbx($this->get('reg_exp_search'));?>" size="40" data-role="reg_exp_search" />
		</div>
	</div>
	<?//?>
	<div class="plugin-form__field">
