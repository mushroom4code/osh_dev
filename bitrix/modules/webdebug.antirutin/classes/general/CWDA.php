...
class CWDA {
	 ...
	 *	Get list of prices
	 */
	static function GetPriceTypeList($IBlockID=false, $arSort=array()) {
		$arResult = array();
	...
	function AddElementCatalogPrices(&$arElement){
	...
	function GetVatList($Empty=true) {
		$arResult = array();
		if($Empty){
	...
	function GetMeasureRatio($ProductID) {
		$mResult = 1;
		if (CModule::IncludeModule('catalog')) {
