...
<div class="profile-save__form wda-form">
	<form action="<?=POST_FORM_ACTION_URI;?>" method="post" data-role="wdi_profile_save_form">
		<?if($intProfileId > 0):?>
		...
		<?endif?>
		<div class="profile-save__form-field">
			<div class="profile-save__form-field-title"><?=Helper::getMessage($strLang.'FIELD_NAME');?></div>
			<div class="profile-save__form-field-value">
		...
		<div class="profile-save__form-field profile-save__form-field-50">
			<div class="profile-save__form-field-title"><?=Helper::getMessage($strLang.'FIELD_CODE');?></div>
			<div class="profile-save__form-field-value">
		...
		<div class="profile-save__form-field profile-save__form-field-50">
			<div class="profile-save__form-field-title"><?=Helper::getMessage($strLang.'FIELD_SORT');?></div>
			<div class="profile-save__form-field-value">
		...
		<div class="profile-save__form-field">
			<div class="profile-save__form-field-title"><?=Helper::getMessage($strLang.'FIELD_DESCRIPTION');?></div>
			<div class="profile-save__form-field-value">
