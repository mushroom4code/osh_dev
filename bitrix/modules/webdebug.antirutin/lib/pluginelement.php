...
abstract class PluginElement extends Plugin {
	 ...
	 *	Get offers (just ID)
	 */
	protected function getElementOffers($intElementId){
		$arElement = IBlock::getElementArray($intElementId, $this->intIBlockId, ['OFFERS' => true]);
	...
	protected function update($intElementId, $arFields, $bUpdateSearch=true, $bResizePictures=false, $bCheckDiskQuota=true){
		if(\Bitrix\Main\Loader::includeModule('iblock')){
			...
			$bResult = $this->obElement->update($intElementId, $arFields, $bUpdateSearch, $bResizePictures, $bCheckDiskQuota);
			if($bResult){
	 ...
	 *	
	 */
	protected function updateElementIndex($v){
