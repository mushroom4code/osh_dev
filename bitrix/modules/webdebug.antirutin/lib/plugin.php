...
abstract class Plugin {
	...
	public function getOffersIBlockId(){
		...
		return is_array($arCatalog) ? $arCatalog['OFFERS_IBLOCK_ID'] : false;
	}
...
%3$s;
	 ...
	 */
	public function selectBox($strName, $arValues, $strSelected=null, $strDefault=null, $strAttr=null){
		return Helper::selectBox($strName, $arValues, $strSelected, $strDefault, $strAttr);
	}
