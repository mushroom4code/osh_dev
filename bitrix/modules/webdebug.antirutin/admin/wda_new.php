...
# Show demo
require realpath(__DIR__.'/../install/demo.php');
if(!$bModule || $bExpired){
...
\CJSCore::Init(['jquery', 'jquery2', 'file_input', 'fileinput', 'html_editor']);
...
<?$obTabControl->beginNextTab();?>
	...
	<tr class="heading wda-hidden"><td colspan="2">
		...
		<a href="#" data-role="filter-show" class="wda-filter-show wda-not-select"
		...
		<td colspan="2" class="adm-detail-content-cell-r">
			...
			<div data-role="wda_filter_section_restrictions" style="display:none;">
				...
				if(!IBlock::isSectionD7Available()){
					print Helper::showNote(Helper::getMessage('WDA_FILTER_NOTICE_SECTION_RESTRICTIONS', [
	...
	<tr class="heading wda-hidden">
		<td colspan="2">
			...
			<a href="#" data-role="task-settings" class="wda-task-settings wda-not-select"
	...
	<tr class="heading" style="display:none;">
		<td colspan="2"><?=Helper::getMessage('WDA_HEADER_TASK');?>
			<a href="#" data-role="task-sort" class="wda-task-sort wda-not-select"
