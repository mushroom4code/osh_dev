...
class TurnoverRef extends Profile implements Profileinterface{
	...
	protected function checkSMSList(){
		...
		if(empty($this->profileSetting['sms_settings']['SKYWEB24_LOYAL_TURNOVER_REF_SMS'])){
			$this->profileSetting['sms_settings']['SKYWEB24_LOYAL_TURNOVER_REF_SMS']=[
				'refTemplate'=>0
			];
		}
		$this->checkSMSMain();
	...
	protected function SMSType($type){
		$SMSType = [
			'SKYWEB24_LOYAL_TURNOVER_REF_SMS'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_TURNOVER_REF_SMS',
				'EVENT_TYPE'  => 'sms',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_SMS_TURNOVER_REF"),
				'DESCRIPTION'=>Loc::getMessage("skyweb24.loyaltyprogram_SMS_TURNOVER_REF_DESC")
			]
		];
		return $SMSType[$type];
	}
	...
	protected function SMSTemplates($key){
		...
		$smsTemplates = [
			'refTemplate'=>[
				...
				"RECEIVER" => "#USER_PHONE#",
				"MESSAGE" => GetMessage("skyweb24.loyaltyprogram_SMS_TURNOVER_REF_REFBONUSADD")
			]
		];
	...
	private function getRefSMS($userId, $bonus, $turnover){
		...
		if(!empty($SMSSettings['SKYWEB24_LOYAL_TURNOVER_REF_SMS']['refTemplate'])){
			...
			if(!empty($tmpPhone)){
				...
				return [
					"EVENT_NAME" => "SKYWEB24_LOYAL_TURNOVER_REF_SMS",
					"MESSAGE_ID" => $SMSSettings['SKYWEB24_LOYAL_TURNOVER_REF_SMS']['refTemplate'],
					"LID" => $userData['LID'],
					"C_FIELDS" => [
						"USER_PHONE" => $tmpPhone,
						"BONUS"=>strval($bonus),
	...
	protected function checkEmailList(){
		...
		if(empty($this->profileSetting['email_settings']['SKYWEB24_LOYAL_TURNOVER_REF'])){
			$this->profileSetting['email_settings']['SKYWEB24_LOYAL_TURNOVER_REF']=[
				'refTemplate'=>0
			];
		}
		$this->checkEmailMain();
	...
	protected function mailType($type){
		$mailType = [
			'SKYWEB24_LOYAL_TURNOVER_REF'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_TURNOVER_REF',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSTURNOVER_REF"),
				'DESCRIPTION'=>'
					#EMAIL_TO# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSTURNOVER_REF_EMAIL_TO").'
					#BONUS# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSTURNOVER_REF_BONUS").'
					#TURNOVER# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSTURNOVER_REF_TURNOVER").'
				',
				'SORT'=>500
			]
		];
	...
	protected function mailTemplates($key){
		...
		$mailTemplates = [
			'refTemplate'=>[
				...
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSTURNOVER_PARENTREFBONUSADD"),
	...
	private function getRefEmail($userId, $bonus, $turnover){
		...
		if(!empty($emailSettings['SKYWEB24_LOYAL_TURNOVER_REF']['refTemplate'])){
			$rsEM = \CEventMessage::GetByID($emailSettings['SKYWEB24_LOYAL_TURNOVER_REF']['refTemplate']);
			if($arEM = $rsEM->Fetch()){
				$sites=array_keys($this->globalSettings->getSites());
				global $DB;
				...
				if(!empty($arUser['EMAIL'])){
					return [
						"EVENT_NAME" => "SKYWEB24_LOYAL_TURNOVER_REF",
						"MESSAGE_ID" => $emailSettings['SKYWEB24_LOYAL_TURNOVER_REF']['refTemplate'],
	...
	*/
	...
	public function getConditions($mode=''){
		...
		$mainParams=[[
            ...
            'group'=> false,
            'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_sites_ref"),
            'showIn'=> ['registerbyParentRef', 'registerbyParentRefSubGrp'],
            'control'=> [[
                'id'=> 'prefix',
                'type'=> 'prefix',
                'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_siteEqual_ref")
            ], [
                'id'=> 'logic',
                'name'=> 'logic',
                'type'=> 'select',
            ...
            [
                ...
                'group'=> false,
                'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_GroupRef"),
                'showIn'=> ['registerbyParentRef', 'registerbyParentRefSubGrp'],
                'control'=> [[
                    'id'=> 'prefix',
                    'type'=> 'prefix',
                    'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_GroupRef")
                ], [
                    'id'=> 'logic',
                    'name'=> 'logic',
                    'type'=> 'select',
                ...
                'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_countUsersRef"),
                'group'=> false,
                'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_countUsersRef"),
                'showIn'=> ['registerbyParentRef', 'registerbyParentRefSubGrp'],
                'control'=> [[
                    'id'=> 'prefix',
                    'type'=> 'prefix',
                    'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_countUsersRef")
                ], [
                    'id'=> 'logic',
                    'name'=> 'logic',
                    'type'=> 'select',
            ...
            [
                'controlId'=> 'turnover',
                'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_turnoverPeriodRef"),
                'group'=> false,
                'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_turnoverPeriodRef"),
                'showIn'=> ['registerbyParentRef', 'registerbyParentRefSubGrp'],
                'control'=> [[
                    'id'=> 'prefix',
                    'type'=> 'prefix',
                    'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_turnoverPeriodRef")
                ], [
                    'id'=> 'logic',
                    'name'=> 'logic',
                    'type'=> 'select',
                ...
                'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_countOrdersRef"),
                'group'=> false,
                'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_countOrdersRef"),
                'showIn'=> ['registerbyParentRef', 'registerbyParentRefSubGrp'],
                'control'=> [[
                    'id'=> 'prefix',
                    'type'=> 'prefix',
                    'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_countOrdersRef")
                ], [
                    'id'=> 'logic',
                    'name'=> 'logic',
                    'type'=> 'select',
                ...
                'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_levelUserRef"),
                'group'=> false,
                'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_levelUserRef"),
                'showIn'=> ['registerbyParentRef', 'registerbyParentRefSubGrp'],
                'control'=> [[
                    'id'=> 'prefix',
                    'type'=> 'prefix',
                    'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_levelUserRef")
                ], [
                    'id'=> 'logic',
                    'name'=> 'logic',
                    'type'=> 'select',
			...
			[
				...
				'control'=> [
					...
					[
						...
						'type'=> 'select',
						'values'=> [
							'percent'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_UNIT_PERCENT_TURNOVER_USER_REF"),
							'bonus'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_UNIT_BONUS")
						],
						'defaultText'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_UNIT_PERCENT_TURNOVER_USER_REF"),
