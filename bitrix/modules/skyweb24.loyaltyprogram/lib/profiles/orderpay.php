...
class Orderpay extends Profile implements Profileinterface{
	...
	protected function checkSMSList(){
		...
		if(empty($this->profileSetting['sms_settings']['SKYWEB24_LOYAL_ORDERPAY_SMS'])){
			$this->profileSetting['sms_settings']['SKYWEB24_LOYAL_ORDERPAY_SMS']=[
				'userTemplate'=>0
			];
		}
		$this->checkSMSMain();
	...
	protected function SMSType($type){
		$SMSType = [
			'SKYWEB24_LOYAL_ORDERPAY_SMS'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_ORDERPAY_SMS',
				'EVENT_TYPE'  => 'sms',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_SMS_ORDERPAY"),
				'DESCRIPTION'=>Loc::getMessage("skyweb24.loyaltyprogram_SMS_ORDERPAY_DESC")
			]
		];
		return $SMSType[$type];
	}
	...
	protected function SMSTemplates($key){
		...
		$smsTemplates = [
			'userTemplate'=>[
				...
				"RECEIVER" => "#USER_PHONE#",
				"MESSAGE" => GetMessage("skyweb24.loyaltyprogram_SMS_ORDERPAY_USERBONUSPAY")
			]
		];
	...
	public function sendSMS($bonus=0){
		...
		if(!empty($SMSSettings['SKYWEB24_LOYAL_ORDERPAY_SMS']['userTemplate']) && $bonus>0){
			...
			if(!empty($tmpPhone)){
				...
				$sms->setTemplate($SMSSettings['SKYWEB24_LOYAL_ORDERPAY_SMS']['userTemplate']);
	...
	protected function checkEmailList(){
		...
		if(empty($this->profileSetting['email_settings']['SKYWEB24_LOYAL_ORDERPAY'])){
			$this->profileSetting['email_settings']['SKYWEB24_LOYAL_ORDERPAY']=[
				'userTemplate'=>0
			];
		}
		$this->checkEmailMain();
	...
	protected function mailType($type){
		$mailType = [
			'SKYWEB24_LOYAL_ORDERPAY'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_ORDERPAY',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSPAY"),
				'DESCRIPTION'=>'
					#EMAIL_TO# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSPAY_EMAIL_TO").'
					#BONUS# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSPAY_BONUS").'
					#BONUS_LEFT# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSPAY_BONUS_LEFT").'
				',
				'SORT'=>500
			]
		];
	...
	protected function mailTemplates($key){
		...
		$mailTemplates = [
			'userTemplate'=>[
				...
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSPAY_USERBONUSPAY"),
	...
	public function sendEvent($bonus){
		if(!empty($this->profileSetting['email_settings']['SKYWEB24_LOYAL_ORDERPAY']['userTemplate'])){
	...
	public function getConditions($mode=''){
		...
		$params = [
			[
				'controlId'=> 'registerbyRef',
				'group'=> true,
				'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_bonusPayGroup"),
				'showIn'=> ['CondGroup'],
				'visual'=> [
					'controls'=> ['All', 'True'],
					'values'=> [[
				...
				'control'=> [
					...
					Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_allowPay"),
					[
						'id'=> 'bonus',
						'name'=> 'bonus',
						'type'=> 'input',
					...
					[
						...
						'values'=> [
                            ...
                            'F'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_fix_min"),
					...
					[
						...
						'show_value'=>'Y',
						'defaultValue'=>'',
						'defaultText'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_UNLIMITED_BONUS"),
					],
			...
			[
				...
				'children'=> [[
					...
					'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_product_basket_pay"),
					'group'=> false,
					'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_product_basket"),
					'showIn'=> ['registerbyRef', 'registerbyRefSubGrp'],
					'control'=> [[
						'id'=> 'prefix',
						'type'=> 'prefix',
						'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_product_basket")
					],[
						'id'=> 'logic',
						'name'=> 'logic',
						'type'=> 'select',
					...
					'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_section_basket_pay"),
					'group'=> false,
					'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_section_basket"),
					'showIn'=> ['registerbyRef', 'registerbyRefSubGrp'],
					'control'=> [[
						'id'=> 'prefix',
						'type'=> 'prefix',
						'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_section_basket")
					],[
						'id'=> 'logic',
						'name'=> 'logic',
						'type'=> 'select',
					...
					'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_price_basket"),
					'group'=> false,
					'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_price_basket"),
					'showIn'=> ['registerbyRef', 'registerbyRefSubGrp'],
					'control'=> [[
						'id'=> 'prefix',
						'type'=> 'prefix',
						'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_price_basket")
					],
					[
						'id'=> 'logic',
						'name'=> 'logic',
