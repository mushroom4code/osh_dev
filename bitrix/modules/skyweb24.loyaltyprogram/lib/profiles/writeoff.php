...
class Writeoff extends Profile implements Profileinterface{
	...
	protected function checkEmailList(){
		...
		if(empty($this->profileSetting['email_settings']['SKYWEB24_LOYAL_WRITEOFF'])){
			$this->profileSetting['email_settings']['SKYWEB24_LOYAL_WRITEOFF']=[
				'userTemplate'=>0,
	...
	protected function mailType($type){
		$mailType = [
			'SKYWEB24_LOYAL_WRITEOFF'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_WRITEOFF',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSWRITEOFF"),
				'DESCRIPTION'=>'
					#EMAIL_TO# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSWRITEOFF_EMAIL_TO").'
					#BONUS# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSWRITEOFF_BONUS").'
					#BONUS_ID# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSWRITEOFF_BONUS_ID").'
					#USER_ID# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSWRITEOFF_USER_ID").'
					#USER_NAME# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSWRITEOFF_USER_NAME").'
				',
				'SORT'=>500
			]
		];
	...
	protected function mailTemplates($key){
		...
		$mailTemplates = [
			'userTemplate'=>[
				...
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSPAY_USERBONUSWRITEOF"),
			...
			'adminTemplate'=>[
				...
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSPAY_ADMINBONUSWRITEOF"),
	...
	public function sendEvent($params){
		...
		$templateId=$this->profileSetting['email_settings']['SKYWEB24_LOYAL_WRITEOFF'][$params['type']];
	...
	public function writeBonus($bonus, $regId){
		global $DB;
		...
		$upd=\CSaleUserAccount::UpdateAccount(
			...
			"SKYWEB24_LOYAL_WRITEOFF",
			'',
			Loc::getMessage("skyweb24.loyaltyprogram_PROGRAM_WRITEOFF_RESERV")
		);
		...
		if($upd!==false){
			...
			$id = $DB->Insert($this->globalSettings->getTableWriteOff(), [
				'bonus'=>$bonus,
				'user_id'=>$this->idUser,
				'status'=>'"request"',
	...
	*/
	...
	public function getConditions($mode=''){
		...
		$mainParams=[[
            ...
            'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_hint_size_writeoff"),
            'group'=> false,
            'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_size_writeoff"),
            'showIn'=> ['registerbyRef', 'registerbyRefSubGrp'],
            'control'=> [[
                'id'=> 'prefix',
                'type'=> 'prefix',
                'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_size_writeoff")
            ],
                [
                    'id'=> 'logic',
                    'name'=> 'logic',
		...
		$params = [
			[
				'controlId'=> 'registerbyRef',
				'group'=> true,
				'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_bonusWriteOff"),
				'showIn'=> ['CondGroup'],
				'visual'=> [
					'controls'=> ['All', 'True'],
					'values'=> [[
				...
				'control'=> [
					...
					Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_allowWriteOff"),
					[
						'id'=> 'bonus',
						'name'=> 'bonus',
						'type'=> 'input',
