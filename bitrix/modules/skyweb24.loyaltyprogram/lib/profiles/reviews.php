	...
	*/
	...
	public function getConditions($mode=''){
		...
		$mainParams=[[
            ...
            'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_birthday_GroupRef"),
            'group'=> false,
            ...
            'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_levelParentRef_hint"),
            'group'=> false,
		...
		$params = [
			[
				...
				'control'=> [
					...
					Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_bonusbyReview"),
					[
						'id'=>'through_time',
						'name'=>'through_time',
						'type'=> 'select',
			...
			[
				...
				'control'=> [
					...
					Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_BonusParentRefByRegReview"),
					[
						'id'=>'through_time',
						'name'=>'through_time',
						'type'=> 'select',
			...
			[
				'controlgroup'=> true,
				'group'=> false,
				'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_ReviewParameters"),
				'showIn'=> ['registerbyRef', 'registerbyRefSubGrp', 'registerbyParentRef', 'registerbyParentRefSubGrp'],
				'children'=> 
				[
					// [
					// 	'controlId'=> 'typeReview',
					// 	'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeReview_hint"),
					// 	'group'=> false,
					// 	'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeReview"),
					// 	'showIn'=> ['registerbyRef', 'registerbyRefSubGrp', 'registerbyParentRef', 'registerbyParentRefSubGrp'],
					// 	'control'=>
					// 	[
					// 		[
					// 		'id'=> 'prefix',
					// 		'type'=> 'prefix',
					// 		'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeReview")
					// 		], 
					// 		[
					// 		'id'=> 'logic',
					// 		'name'=> 'logic',
					...
					// 		'values'=> 
					// 			[
					// 			'blog'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkBlog"),
					// 			'forum'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkForum")
					// 			],
					// 		'id'=> 'type_review',
					// 		'name'=> 'type_review',
					// 		'show_value'=>'Y',
				...
				[
					'controlId'=> 'IDForum',
					'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDForum_hint"),
					'group'=> false,
					'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDForum"),
					'showIn'=> ['registerbyRef', 'registerbyRefSubGrp', 'registerbyParentRef', 'registerbyParentRefSubGrp'],
					'control'=> [[
						'id'=> 'prefix',
						'type'=> 'prefix',
						'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDForum")
					], [
						'id'=> 'logic',
						'name'=> 'logic',
						'type'=> 'select',
				...
				[
					'controlId' => 'IDIBlock',
					'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDIBlock"),
					'group'=> false,
					'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDIBlock"),
					'showIn'=> ['registerbyRef', 'registerbyRefSubGrp', 'registerbyParentRef', 'registerbyParentRefSubGrp'],
					'control'=> [[
						'id'=> 'prefix',
						'type'=> 'prefix',
						'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDIBlock")
					], [
						'id'=> 'logic',
						'name'=> 'logic',
						'type'=> 'select',
					...
					'controlId'=> 'moderate',
					'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_REVIEW_MODERATE_hint"),
					'group'=> false,
					'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_REVIEW_MODERATE"),
					'showIn'=> ['registerbyRef', 'registerbyRefSubGrp', 'registerbyParentRef', 'registerbyParentRefSubGrp'],
					'control'=> [[
						'id'=> 'prefix',
						'type'=> 'prefix',
						'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_REVIEW_MODERATE")
					],[
						'type'=> 'select',
						'multiple'=>'Y',
						'values'=> [
					...
					'controlId'=> 'IDBlog',
					'description'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDBlog_hint"),
					'group'=> false,
					'label'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDBlog"),
					'showIn'=> ['registerbyRef', 'registerbyRefSubGrp', 'registerbyParentRef', 'registerbyParentRefSubGrp'],
					'control'=> [[
						'id'=> 'prefix',
						'type'=> 'prefix',
						'text'=> Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_IDBlog")
					], [
						'id'=> 'logic',
						'name'=> 'logic',
						'type'=> 'select',
						...
						if($nextO['controlId']=='registerbyRef'){
							if(!empty($nextO['values']['bonus'])){
								...
								$fields=[
									...
									'add_comment'=>'"'.$DB->ForSql(Loc::getMessage("skyweb24.loyaltyprogram_BONUS_USER_REVIEW", ["#NUM#"=>$nextO['values']['bonus']])).' ('.$this->parameters['topuc_name'].')"',
									'email'=>"'".$mailTmplt."'",
									'sms'=>"'".$SMSTmplt."'"
								];
								//action_id
	...
	private function setReferalBonuses($nextO){
		...
		if((int) $params['bonus']>0 && count($newRew)>0){
			...
			foreach($newRew as $nextRew){
				...
				$insertArr['add_comment']='"'.$DB->ForSql(Loc::getMessage("skyweb24.loyaltyprogram_BONUS_REF_REVIEW", ["#NUM#"=>$params['bonus']])).' ('.$this->parameters['topuc_name'].')"';
	...
	protected function checkSMSList(){
		...
		if(empty($this->profileSetting['sms_settings']['SKYWEB24_LOYAL_REVIEWS_SMS'])){
			$this->profileSetting['sms_settings']['SKYWEB24_LOYAL_REVIEWS_SMS']=[
				'userTemplate'=>0,
				'refTemplate'=>0
			];
		}
	...
	protected function SMSType($type){
		$SMSType = [
			'SKYWEB24_LOYAL_REVIEWS_SMS'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_REVIEWS_SMS',
				'EVENT_TYPE'  => 'sms',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_SMS_REVIEWS"),
				'DESCRIPTION'=>Loc::getMessage("skyweb24.loyaltyprogram_SMS_REVIEWS_DESC")
			]
		];
		return $SMSType[$type];
	}
	...
	protected function SMSTemplates($key){
		...
		$smsTemplates = [
			'userTemplate'=>[
				...
				"RECEIVER" => "#USER_PHONE#",
				"MESSAGE" => GetMessage("skyweb24.loyaltyprogram_SMS_REVIEWS_USERBONUSADD")
			],
			'refTemplate'=>[
				'EVENT_NAME'=>'SKYWEB24_LOYAL_REVIEWS_SMS',
				"ACTIVE" => false,
				"SENDER" => "#DEFAULT_SENDER#",
				"RECEIVER" => "#USER_PHONE#",
				"MESSAGE" => GetMessage("skyweb24.loyaltyprogram_SMS_REVIEWS_REFBONUSADD")
			]
		];
	...
	private function getRefSMS($userId, $bonus){
		...
		if(!empty($SMSSettings['SKYWEB24_LOYAL_REVIEWS_SMS']['refTemplate'])){
			...
			if(!empty($tmpPhone)){
				...
				return [
					"EVENT_NAME" => "SKYWEB24_LOYAL_REVIEWS_SMS",
					"MESSAGE_ID" => $SMSSettings['SKYWEB24_LOYAL_REVIEWS_SMS']['refTemplate'],
					"LID" => $userData['LID'],
					"C_FIELDS" => [
						"USER_PHONE" => $tmpPhone,
						"BONUS"=>strval($bonus)
	...
	private function getUserSMS($userId, $bonus){
		$SMSSettings=$this->profileSetting['sms_settings'];
		if(!empty($SMSSettings['SKYWEB24_LOYAL_REVIEWS_SMS']['userTemplate'])){
			$userData=Tools::getUserData($userId);
			if(!empty($userData['PERSONAL_PHONE'])){
				$tmpPhone=$userData['PERSONAL_PHONE'];
			}elseif(!empty($userData['PERSONAL_MOBILE'])){
			...
			if(!empty($tmpPhone)){
				...
				return [
					"EVENT_NAME" => "SKYWEB24_LOYAL_REVIEWS_SMS",
					"MESSAGE_ID" => $SMSSettings['SKYWEB24_LOYAL_REVIEWS_SMS']['userTemplate'],
					"LID" => $userData['LID'],
					"C_FIELDS" => [
						"USER_PHONE" => $tmpPhone,
						"BONUS"=>strval($bonus)
	...
	protected function checkEmailList(){
		...
		if(empty($this->profileSetting['email_settings']['SKYWEB24_LOYAL_REVIEWS'])){
			$this->profileSetting['email_settings']['SKYWEB24_LOYAL_REVIEWS']=[
				'userTemplate'=>0,
				'refTemplate'=>0
			];
		}
	...
	protected function mailType($type){
		$mailType = [
			'SKYWEB24_LOYAL_REVIEWS'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_REVIEWS',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_EVENT_REVIEWS"),
				'DESCRIPTION'=>'
					#EMAIL_TO# - '.Loc::getMessage("skyweb24.loyaltyprogram_REVIEWS_EMAIL_TO").'
					#BONUS# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_REVIEWS_BONUS").'
					#REVIEWS_NAME# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_REVIEWS_REVIEWSNAME").'
				',
				'SORT'=>500
			]
		];
	...
	protected function mailTemplates($key){
		...
		$mailTemplates = [
			'userTemplate'=>[
				...
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_REVIEWS_USERBONUSADD"),
			...
			'refTemplate'=>[
				...
				'EMAIL_FROM'=>'#DEFAULT_EMAIL_FROM#',
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_REVIEWS_REFBONUSADD"),
	...
	private function getUserEmail($userId, $bonus, $review){
		...
		if(!empty($emailSettings['SKYWEB24_LOYAL_REVIEWS']['userTemplate'])){
			$rsEM = \CEventMessage::GetByID($emailSettings['SKYWEB24_LOYAL_REVIEWS']['userTemplate']);
			if($arEM = $rsEM->Fetch()){
				$sites=array_keys($this->globalSettings->getSites());
				...
				if(!empty($arUser['EMAIL'])){
					return [
						"EVENT_NAME" => "SKYWEB24_LOYAL_REVIEWS",
						"MESSAGE_ID" => $emailSettings['SKYWEB24_LOYAL_REVIEWS']['userTemplate'],
	...
	private function getRefEmail($userId, $bonus, $review){	
		$emailSettings=$this->profileSetting['email_settings'];
		if(!empty($emailSettings['SKYWEB24_LOYAL_REVIEWS']['refTemplate'])){
			global $DB;
			$results=$DB->Query('select * from b_user where id='.$userId);
			$arUser = $results->Fetch();
			if(!empty($arUser['EMAIL'])){
				...
				if(!isset($this->refTemplate)){
					$rsEM = \CEventMessage::GetByID($emailSettings['SKYWEB24_LOYAL_REVIEWS']['refTemplate']);
					if($arEM = $rsEM->Fetch()){
				...
				if($this->refTemplate!==false){
					return [
						"EVENT_NAME" => "SKYWEB24_LOYAL_REVIEWS",
						"MESSAGE_ID" => $emailSettings['SKYWEB24_LOYAL_REVIEWS']['refTemplate'],
						"LANGUAGE_ID" => LANGUAGE_ID,
						"LID" => $sites[0],
						"C_FIELDS" => [
							"EMAIL_TO" => $arUser['EMAIL'],
