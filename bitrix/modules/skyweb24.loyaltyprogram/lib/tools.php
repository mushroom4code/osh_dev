...
class Tools {
	...
	*/
	...
	public static function getAllTypeLinkList(){
		return [
			1=>['code'=>'simple', 'name'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkSimple")],
			2=>['code'=>'link', 'name'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkRefLink")],
			3=>['code'=>'coupon', 'name'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkCoupons")],
			4=>['code'=>'manual', 'name'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkManual")],
			5=>['code'=>'import', 'name'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkImport")],
            6=>['code'=>'partnerSite', 'name'=>Loc::getMessage("skyweb24.loyaltyprogram_CONDITION_LABEL_typeLinkPartnerSite")]
		];
	}
	/**
	...
	*/
	public static function controlCoupon($order=false){
		...
		if($userId>0){
			...
			if($publicUsed){
				$userCoupons=[];
				$result = \Skyweb24\Loyaltyprogram\Entity\CouponsTable::getList(['filter'=>['user_id'=>$userId]]);
