...
class Settings{
	...
	private function __construct(){
		$this->module_id='skyweb24.loyaltyprogram';
		$this->tableProfilesList='skyweb24_loyal_profiles';
		$this->tableUsersList='skyweb24_loyal_users';
		$this->tableBonusList='skyweb24_loyal_bonuses';
		$this->tableTransactionList='skyweb24_loyal_bonuses_transaction';
		$this->tableRefCoupons='skyweb24_loyal_coupons';
		$this->tableRuleDescription='skyweb24_loyal_rule_desc';
		$this->tableStatLink='skyweb24_loyal_stat_link';
		$this->tableStatSite='skyweb24_loyal_stat_site';
		$this->tableStatDetail='skyweb24_loyal_detail_stat';
		$this->tableWriteOff='skyweb24_loyal_write_off';
		$this->tableUserRequisites='skyweb24_loyal_user_requisites';
		$this->tableActionList='skyweb24_loyal_action_list';
		$this->tablePartnerSiteList='skyweb24_loyal_partner_sites';
		$this->tableSubscribeUser='skyweb24_loyal_subscribe_user';
		$this->options=[];
