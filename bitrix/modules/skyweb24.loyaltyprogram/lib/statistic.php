...
class Statistic{
	...
	public static function drawStatistics($id){
		...
		//get type profile
		$result=$DB->Query('select * from skyweb24_loyal_profiles where id='.$id.';');
		$row = $result->Fetch();
		if($row['type']=='Writeoff'){
			$result=$DB->Query('select
				...
				from skyweb24_loyal_write_off where profile_id='.$id.' and status!="request"
			...
			$result=$DB->Query('select
				...
				from skyweb24_loyal_bonuses where profile_id='.$id.'
		...
		\CAdminMessage::ShowMessage([
			"TYPE"=>"OK",
			"MESSAGE"=>\Bitrix\Main\Localization\Loc::getMessage("skyweb24.loyaltyprogram_STATISTICS_IS_EMPTY")
		]);
		?></td></tr>
		<?}else{?>
		<tr>
			<td width="40%"><?=\Bitrix\Main\Localization\Loc::getMessage("skyweb24.loyaltyprogram_STATISTICS_FIRST_DATE")?>:</td>
			<td width="60%"><?=$startDate?></td>
		</tr>
		<tr>
			<td width="40%"><?=\Bitrix\Main\Localization\Loc::getMessage("skyweb24.loyaltyprogram_STATISTICS_LAST_DATE")?>:</td>
			<td width="60%"><?=$endDate?></td>
		</tr>
		<tr>
			<td width="40%"><?=\Bitrix\Main\Localization\Loc::getMessage("skyweb24.loyaltyprogram_STATISTICS_BONUS")?>:</td>
			<td width="60%"><?=Tools::numberFormat($totalBonus)?></td>
		</tr>
		<tr>
			<td width="40%"><?=\Bitrix\Main\Localization\Loc::getMessage("skyweb24.loyaltyprogram_STATISTICS_TRIGGERS")?>:</td>
							...
							"graphs":[
									{
										...
										"hideBulletsCount": 30,
										"title": "<?=\Bitrix\Main\Localization\Loc::GetMessage("skyweb24.loyaltyprogram_STATISTICS_AXIS_TRIGGERS")?>",
										...
										"bulletBorderThickness": 1,
										"hideBulletsCount": 30,
										"title": "<?=\Bitrix\Main\Localization\Loc::GetMessage("skyweb24.loyaltyprogram_STATISTICS_AXIS_BONUS")?>",
										"valueField": "bonuses",
										"fillAlphas": 0
									}
							],
