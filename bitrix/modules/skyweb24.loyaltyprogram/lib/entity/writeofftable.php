<?php
namespace Skyweb24\Loyaltyprogram\Entity;
...
class WriteOffTable extends DataManager
{
    ...
    {
        return 'skyweb24_loyal_write_off';
    }
    ...
    public static function getStatuses(){
        return [
            'request'=>Loc::getMessage("skyweb24.loyaltyprogram_WO_STATUS_REQUEST"),
            'execute'=>Loc::getMessage("skyweb24.loyaltyprogram_WO_STATUS_EXECUTE"),
            'reject'=>Loc::getMessage("skyweb24.loyaltyprogram_WO_STATUS_REJECT")
        ];;
    }
}