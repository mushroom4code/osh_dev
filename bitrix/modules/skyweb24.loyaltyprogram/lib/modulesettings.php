...
class Modulesettings{
	...
	private function checkGeneralTemplatesType(){
		$res=\Bitrix\Main\Mail\Internal\EventTypeTable::getList(
			['filter'=>['EVENT_NAME'=>'SKYWEB24_LOYAL_GENERAL']]
		);
		if(!$nextRes=$res->fetch()){
			$fieldsEvent=[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_GENERAL',
				'NAME'=>Loc::getMessage("skyweb24.loyaltyprogram_EVENT_GENERAL"),
				'DESCRIPTION'=>'
					#EMAIL_TO# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_GENERAL_EMAIL_TO").'
					#BONUS# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_BONUSES").'
					#BONUSMESSAGE# - '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_GENERAL_BONUSMESSAGE").'
				',
				'SORT'=>500
			];
	...
	private function mailTemplates(){
		...
		return [
			'etemplate_overdue'=>[
				...
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_GENERAL_OVERDUE"),
			...
			'etemplate_before_overdue'=>[
				...
				'EMAIL_FROM'=>'#DEFAULT_EMAIL_FROM#',
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_GENERAL_BEFORE_OVERDUE"),
			...
			'etemplate_group_bonusacc'=>[
				...
				'EMAIL_FROM'=>'#DEFAULT_EMAIL_FROM#',
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_GENERAL_GROUPACC"),
			...
			'etemplate_group_bonusremove'=>[
				...
				'EMAIL_FROM'=>'#DEFAULT_EMAIL_FROM#',
				'EMAIL_TO'=>'#EMAIL_TO#',
				'SUBJECT'=>'#SITE_NAME#: '.Loc::getMessage("skyweb24.loyaltyprogram_EVENT_GENERAL_GROUPREMOVE"),
