...
class Transact{
	...
	*/
	...
	private function getTransactTypes(){
		...
		$types=['REFERENCE_ID'=>['all'], 'REFERENCE'=>[Loc::getMessage("skyweb24.loyaltyprogram_ALL")]];
		$rsData = $DB->Query($select);
		while($row = $rsData->Fetch()){
			...
			$tmpName=empty(Loc::getMessage('skyweb24.tr_name_'.$tmpName))?$tmpName:Loc::getMessage('skyweb24.tr_name_'.$tmpName);
	...
	public function initFilter(){
		...
		$oFilter = new \CAdminFilter(
			...
			[
				Loc::getMessage("skyweb24.loyaltyprogram_HEADER_DATE_PERIOD"),
				Loc::getMessage("skyweb24.loyaltyprogram_HEADER_BONUS_ID_USER"),
				Loc::getMessage("skyweb24.loyaltyprogram_HEADER_DESCRIPTION"),
				Loc::getMessage("skyweb24.loyaltyprogram_HEADER_BONUS_ID_TRANSACT"),
				Loc::getMessage("skyweb24.loyaltyprogram_HEADER_PROFILE_ID"),
				Loc::getMessage("skyweb24.loyaltyprogram_HEADER_ACTION_ID"),
				Loc::getMessage("skyweb24.loyaltyprogram_HEADER_REFERRAL_ID")
			]
		);?>
		...
		<tr id="tr_PERIOD">
			<td width="40%"><?=Loc::getMessage("skyweb24.loyaltyprogram_HEADER_DATE_PERIOD")?></td>
			<td width="60%"><?
				$periodValue = '';
		...
		<tr>
			<td><b><?=Loc::getMessage("skyweb24.loyaltyprogram_HEADER_BONUS_ID_USER").":"?></b></td>
			<td>
				<?echo FindUserID("find_userId", $find_userId, "", "find_form");?>
			</td>
		</tr>
		<tr>
			<td><?=Loc::getMessage("skyweb24.loyaltyprogram_HEADER_DESCRIPTION").":"?></td>
			<td>
		...
		<tr>
			<td><b><?=Loc::getMessage("skyweb24.loyaltyprogram_HEADER_BONUS_ID_TRANSACT").":"?></b></td>
			<td>
				<input type="text" min=1 step=1 size="25" name="find_id" value="<?echo htmlspecialchars($find_id)?>">
			</td>
		</tr>
		<tr>
			<td><b><?=Loc::getMessage("skyweb24.loyaltyprogram_HEADER_PROFILE_ID").":"?></b></td>
			<td>
				<input type="text" min=1 step=1 size="25" name="find_profileId" value="<?echo htmlspecialchars($find_profileId)?>">
			</td>
		</tr>
		<tr>
			<td><b><?=Loc::getMessage("skyweb24.loyaltyprogram_HEADER_ACTION_ID").":"?></b></td>
			<td>
				<input type="text" min=1 step=1 size="25" name="find_actionId" value="<?echo htmlspecialchars($find_actionId)?>">
			</td>
		</tr>
		<tr>
			<td><b><?=Loc::getMessage("skyweb24.loyaltyprogram_HEADER_REFERRAL_ID").":"?></b></td>
			<td>
				<select name="find_is_parent_ref">
					<option value=""><?=Loc::getMessage("skyweb24.loyaltyprogram_ALL")?></option>
					<option value="1"<?if ($find_is_parent_ref=="1") echo " selected"?>><?=Loc::getMessage("skyweb24.loyaltyprogram_Y")?></option>
					<option value="0"<?if ($find_is_parent_ref=="0") echo " selected"?>><?=Loc::getMessage("skyweb24.loyaltyprogram_N")?></option>
				</select>
			</td>
		</tr>
		<?
	...
	public function initTableList(){
		...
		where b_sale_user_transact.DESCRIPTION!="SKYWEB24_LOYAL_WRITEOFF"
		...
		$this->lAdmin->AddHeaders(array(
			array(
				"id" => "id_transact",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_BONUS_ID_TRANSACT"),
				"sort" => "id_transact",
				"default" => true
			),
			array(
				"id" => "transact_date",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_DATE_ADD"),
				"sort" => "transact_date_sort",
				"default" => true
			),
			array(
				"id" => "user_id",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_USER_ID"),
				"sort" => "user_id",
				"default" => true
			),
			array(
				"id" => "amount",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_BONUS"),
				"sort" => "amount",
				"default" => true
			),
			array(
				"id" => "description",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_DESCRIPTION"),
				"sort" => "description",
				"default" => true
			),
			array(
				"id" => "notes",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_ADD_NOTES"),
				"sort" => "notes",
				"default" => true
			),
			array(
				"id" => "order_id",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_ORDER_ID"),
				"sort" => "order_id",
				"default" => true
			),
			array(
				"id" => "profile_id",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_PROFILE_ID"),
				"sort" => "profile_id",
				"default" => true
			),
			array(
				"id" => "action_id",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_ACTION_ID"),
				"sort" => "action_id",
				"default" => false
			),
			array(
				"id" => "is_parent_ref",
				"content" => Loc::getMessage("skyweb24.loyaltyprogram_HEADER_REFERRAL_ID"),
				"sort" => "is_parent_ref",
				"default" => false
			)
		));
		...
		while($arRes = $rsData->Fetch()){
			...
			$description=empty(Loc::getMessage("skyweb24.tr_name_".$arRes['description']))?$arRes['description']:Loc::getMessage("skyweb24.tr_name_".$arRes['description']);
			$row->AddViewField("description", $description);
			$row->AddViewField("is_parent_ref", $arRes['is_parent_ref']>0?Loc::getMessage("skyweb24.loyaltyprogram_Y"):Loc::getMessage("skyweb24.loyaltyprogram_N"));
		}
