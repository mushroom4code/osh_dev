...
class Bonuspay extends Profile implements Profileinterface{
	...
	protected function checkEmailList(){
		...
		if(empty($this->profileSetting['email_settings']['SKYWEB24_LOYAL_BONUSPAY'])){
			$this->profileSetting['email_settings']['SKYWEB24_LOYAL_BONUSPAY']=[
				'userTemplate'=>0
			];
		}
		$this->checkEmailMain();
	...
	protected function mailType($type){
		$mailType = [
			'SKYWEB24_LOYAL_BONUSPAY'=>[
				'LID'=>LANGUAGE_ID,
				'EVENT_NAME'=>'SKYWEB24_LOYAL_BONUSPAY',
	...
	public function sendEvent($bonus){
		if(!empty($this->profileSetting['email_settings']['SKYWEB24_LOYAL_BONUSPAY']['userTemplate'])){
