...
$generalSettings=new \Skyweb24\Loyaltyprogram\Modulesettings;
if(!empty($request['ajax']) && $request['ajax']=='y'){
	$GLOBALS['APPLICATION']->RestartBuffer();
	if(!empty($request['type']) && $request['type']=='getDescription'){
		...
		$component=new \Skyweb24\Loyaltyprogram\Components;
	...
	*/}elseif(!empty($request['type']) && $request['type']=='updateRest'){
        Skyweb24\Loyaltyprogram\Rest\Manage::deleteApp();
        $appId = Skyweb24\Loyaltyprogram\Rest\Manage::findId();
        if (!$appId) {
            Skyweb24\Loyaltyprogram\Rest\Manage::addApp();
            $data=Skyweb24\Loyaltyprogram\Rest\Manage::findApp();
            // Регистрация обработчика события "OnRestServiceBuildDescription" модуля "rest"
            \Bitrix\Main\EventManager::getInstance()->registerEventHandler(
                'rest',
                'OnRestServiceBuildDescription',
                $module_id,
                'Skyweb24\Loyaltyprogram\Rest\Manage',
                'OnRestServiceBuildDescription'
            );
            echo Loc::getMessage("skyweb24.loyaltyprogram_REST_ID_USER").' - <b>'.$data['USER_ID'].'</b>; '.Loc::getMessage("skyweb24.loyaltyprogram_REST_PASSWORDCODE").' - <b>'.$data['PASSWORD'].'</b>';
            /*echo json_encode([
                Loc::getMessage("skyweb24.loyaltyprogram_REST_ID_USER")=>$data['USER_ID'],
                Loc::getMessage("skyweb24.loyaltyprogram_REST_PASSWORDCODE")=>$data['PASSWORD']
            ]);*/
        }
    }
	die();
...
//list options...
$refUserList=[
	'ID'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_ID"),
	'LOGIN'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_LOGIN"),
	'XML_ID'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_XML_ID"),
	'PROP'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_PROP")	
];

$couponCodeList=[
	'user_id'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_USERID"),
	'user_login'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_USERLOGIN"),
	'user_xml_id'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_USERXMLID"),
	'user_prop'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_USERPROP")
...
$groupUserList=['0'=>'...'];
$rsGroups = CGroup::GetList($by = "id", $order = "asc", array(">ID"=>'1'));
...
$setReferalList=[
	'ONLY_NEW'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_SET_REFERAL_NEW"),
	'ALL'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_SET_REFERAL_ALL")
];

$orderStatuses=[];
foreach(\Skyweb24\Loyaltyprogram\Settings::getInstance()->getOrderStatuses() as $nextStatus){
...
$aTabs = [
	[
		...
		"TAB" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_MAIN"),
		"TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_MAIN_TITLE"),
		"OPTIONS"=>[
			['ref_perform_all', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_PERFORM_ALL_PROFILES"), '', ['checkbox']],
			['ref_detail_stat', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_DETAIL_STAT"), '', ['checkbox']]
		]
	],
	[
		"DIV" => "sw24_general_settings",
		"TAB" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL"),
		"TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_TITLE"),
		"OPTIONS"=>[
			GetMessage("skyweb24.loyaltyprogram_PARAM_MAIN_OPTION"),
			['ref_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_ACTIVE_ALL"), '', ['checkbox']],
			Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_PARTNER"),
			['ref_partner_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_PARTNER_ACTIVE"), '', ['checkbox']],
			GetMessage("skyweb24.loyaltyprogram_PARAM_REF_LINK"),
			['ref_link_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_ACTIVE"), '', ['checkbox']],
			['ref_link_name', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_NAME"), '', ['text', 10]],
			['ref_link_value', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_NAME"), '', ['selectbox', $refUserList]],
			['ref_prop', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_PROPS"), '', ['selectbox', $propUserList]],
			['cookie_time', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_COOKIE_TIME"), '', ['text', 20]],
			['cookie_rename', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_COOKIE_RENAME"), '', ['checkbox']],
			['ref_link_group', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_GROUP"), Bitrix\Main\Config\Option::get($module_id, 'ref_link_group'), ['multiselectbox', $groupUserList]],
			GetMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON"),
			['ref_coupon_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_ACTIVE"), '', ['checkbox']],
			['set_referal', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_SET_REFERAL_NAME"), '', ['selectbox', $setReferalList]],
			['note'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_RULE").'#1'],
			['ref_basket_rules[]',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_BASKET_RULES"), $refBasketRules[0], ['selectbox', $basketRulesList]],
			['ref_coupon_rule_desc', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_CODE_RULE_DESC"), '', ['textarea', ]],
			['ref_coupon_code',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_CODE"), '', ['selectbox', $couponCodeList]],
			['ref_coupon_prop', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_PROPS"), '', ['selectbox', $propUserList]],
			['ref_coupon_rule_xml', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_CODE_RULE_XML"), '', ['text']],
			['ref_coupon_withoutprefix',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_WITHOUTPREFIX"), '', ['checkbox']],
			
			['sample_ref_coupon', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_SAMPLE"), '<div class="sample_ref_link coupon"></div>', ['statichtml']],
			['ref_coupon_istemporary',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_ISTEMPORARY"), '', ['checkbox']],
			['ref_coupon_group', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_COUPON_GROUP"), Bitrix\Main\Config\Option::get($module_id, 'ref_coupon_group'), ['multiselectbox', $groupUserList]],
			['deletelink', '&nbsp;', '<a href="javascript:void(0);" class="delete_coupon_rule">'.Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_RULE_DELETE").'</a>', ['statichtml']],
			GetMessage("skyweb24.loyaltyprogram_PARAM_SUB_OPTION"),
			['group_user', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_GROUP_REFERAL"), '', ['selectbox', $groupUserList]],
			['ref_level', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REFERAL_LEVEL"), '', ['text', 10]],
		]
	],
	[
		"DIV" => "sw24_general_settings_bonus",
		"TAB" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_BONUS"),
		"TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_BONUS_TITLE"),
		"OPTIONS"=>[
			GetMessage("skyweb24.loyaltyprogram_PARAM_ADD_BONUS_OPTION"),
			['bonus_add_active',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_BONUS_ADD_ACTIVE"), '', ['checkbox']],
			GetMessage("skyweb24.loyaltyprogram_PARAM_WRITE_OFF_BONUS_OPTION"),
			['bonus_write_off_active',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_WRITE_OFF_BONUS_ACTIVE"), '', ['checkbox']],
			GetMessage("skyweb24.loyaltyprogram_PARAM_BUY_BONUS_OPTION"),
			['bonus_pay_active',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_BONUS_PAY_ACTIVE"), '', ['checkbox']],
			['ref_insert_to_soa', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_INSERT_TO_SOA"), '', ['checkbox']],
			['bonus_return',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_BONUS_RETURN"), '', ['checkbox']],
			['bonus_as_discount',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_BONUS_AS_DISCOUNT"), '', ['checkbox']],
			['bonus_skip_discount_product',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_BONUS_SKIP_DISCOUNT_PRODUCT"), '', ['checkbox']],
			['bonus_skip_condition_product',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_BONUS_SKIP_CONDITION_PRODUCT"), '', ['checkbox']],
			GetMessage("skyweb24.loyaltyprogram_PARAM_SUB_OPTION"),
			['currency', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_CURRENCY"), '', ['selectbox', $currencyList]],
			['orderstatus', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_ORDERSTATUSES"), '', ['selectbox', $orderStatuses]],
		]
	],
	[
		"DIV" => "sw24_general_settings_etemplates",
		"TAB" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_ETEMPLATES"),
		"TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_ETEMPLATES_TITLE"),
		"OPTIONS"=>[
			['notify_group_bonusacc',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_GROUP_BONUSACC"), '', ['checkbox']],
			['notify_group_bonusremove',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_GROUP_BONUSREMOVE"), '', ['checkbox']],
			['notify_overdue',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_OVERDUE"), '', ['checkbox']],
			['notify_before_overdue',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_BEFORE_OVERDUE"), '', ['checkbox']],
			['notify_delay_overdue', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_DELAY_OVERDUE"), '', ['text', 10]],
			['notify_delay_overdue_type', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_DELAY_OVERDUE_TYPE"), '', ['selectbox', [
				'hour'=>GetMessage("skyweb24.loyaltyprogram_TIME_HOUR"),
				'day'=>GetMessage("skyweb24.loyaltyprogram_TIME_DAY"),
				'week'=>GetMessage("skyweb24.loyaltyprogram_TIME_WEEK"),
				'month'=>GetMessage("skyweb24.loyaltyprogram_TIME_MONTH"),
			]]],
		]
	],
	["DIV" => "sw24_general_agents", "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_AGENTS"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_AGENTS_TITLE")],
	["DIV" => "sw24_general_rest", "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_REST"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_GENERAL_REST_TITLE")],
...
if($request->isPost() && $request['Update'] && check_bitrix_sessid()){
	...
	if(count($request['ref_basket_rules'])>0){
		...
		if(!empty($tmpRules) && count($tmpRules)>0){
			...
			$regEvent=true;
			foreach($handlers as $nextHandler){
				if($nextHandler['TO_CLASS']=='Skyweb24\Loyaltyprogram\Eventmanager' && $nextHandler['TO_METHOD']=='registerByCoupon'){
					$regEvent=false;
					break;
				}
			}
...
$tmpOptions=[
		Loc::getMessage("skyweb24.loyaltyprogram_PARAM_MAIN_OPTION"),
		['ref_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_ACTIVE_ALL"), '', ['checkbox']],
		Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_PARTNER"),
		['ref_partner_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_PARTNER_ACTIVE"), '', ['checkbox']],
		Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_LINK"),
		['ref_link_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_ACTIVE"), '', ['checkbox']],
		['ref_link_name', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_NAME"), '', ['text', 10]],
		['ref_link_value', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_NAME"), '', ['selectbox', $refUserList]],
		['ref_prop', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_PROPS"), '', ['selectbox', $propUserList]],
		['sample_ref_link', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_SAMPLE"), '<div class="sample_ref_link">'.$sampleRefLink.'</div>', ['statichtml']],
		
		['cookie_time', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_COOKIE_TIME"), '', ['text', 20]],
		['cookie_rename', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_COOKIE_RENAME"), '', ['checkbox']],
		['ref_link_group', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_GROUP"), Bitrix\Main\Config\Option::get($module_id, 'ref_link_group'), ['multiselectbox', $groupUserList]],
		
		Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON"),
		['ref_coupon_active', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_ACTIVE"), '', ['checkbox']],
		['set_referal', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_SET_REFERAL_NAME"), '', ['selectbox', $setReferalList]],
		['note'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_RULE").'#1'],
		['ref_basket_rules[]', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_BASKET_RULES"), $refBasketRules[0], ['selectbox', $basketRulesList]],
		...
		['sample_ref_coupon', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_SAMPLE"), '<div class="sample_ref_link coupon">'.$sampleRefCoupons[$refBasketRules[0]]['COUPON'].'</div>', ['statichtml']],
		['ref_coupon_istemporary', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_ISTEMPORARY"), '', ['checkbox']],
		['ref_coupon_group', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_COUPON_GROUP"), Bitrix\Main\Config\Option::get($module_id, 'ref_coupon_group'), ['multiselectbox', $groupUserList]],
...
if(count($refBasketRules)>1){
	foreach($refBasketRules as $key=>$val){
		...
		$tmpOptions[]=['note'=>Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_RULE").'#'.($key+1)];
		$tmpOptions[]=['ref_basket_rules[]',Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_BASKET_RULES"), $refBasketRules[$key], ['selectbox', $basketRulesList]];
		$tmpOptions[]=['ref_coupon_rule_desc'.$key,Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_CODE_RULE_DESC"), '', ['textarea']];
		$tmpOptions[]=['ref_coupon_code'.$key,Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_CODE"), Bitrix\Main\Config\Option::get($module_id, 'ref_coupon_code'.$key), ['selectbox', $couponCodeList]];
		$tmpOptions[]=['ref_coupon_prop'.$key, Loc::getMessage("skyweb24.loyaltyprogram_PARAM_RUL_PROPS"), Bitrix\Main\Config\Option::get($module_id, 'ref_coupon_prop'.$key), ['selectbox', $propUserList]];
		$tmpOptions[]=['ref_coupon_rule_xml'.$key,Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_CODE_RULE_XML"), '', ['text']];
		$tmpOptions[]=['ref_coupon_withoutprefix'.$key,Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_WITHOUTPREFIX"), Bitrix\Main\Config\Option::get($module_id, 'ref_coupon_withoutprefix'.$key), ['checkbox']];
		
		$tmpOptions[]=['sample_ref_coupon', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_SAMPLE"), '<div class="sample_ref_link coupon">'.$sampleRefCoupons[$refBasketRules[$key]]['COUPON'].'</div>', ['statichtml']];
		$tmpOptions[]=['ref_coupon_istemporary'.$key,Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_COUPON_ISTEMPORARY"), Bitrix\Main\Config\Option::get($module_id, 'ref_coupon_istemporary'.$key), ['checkbox']];
		$tmpOptions[]=['ref_coupon_group'.$key, Loc::getMessage("skyweb24.loyaltyprogram_PARAM_COUPON_GROUP"), Bitrix\Main\Config\Option::get($module_id, 'ref_coupon_group'.$key), ['multiselectbox', $groupUserList]];
		$tmpOptions[]=['deletelink', '&nbsp;', '<a href="javascript:void(0);" class="delete_coupon_rule">'.Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_RULE_DELETE").'</a>', ['statichtml']];
	}
}
$tmpOptions[]=GetMessage("skyweb24.loyaltyprogram_PARAM_SUB_OPTION");
$tmpOptions[]=['group_user', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_GROUP_REFERAL"), '', ['selectbox', $groupUserList]];
$tmpOptions[]=['ref_level', Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REFERAL_LEVEL"), '', ['text', 10]];
...
?>
<form class="loyalty_settings" method="post" action="<?echo $APPLICATION->GetCurPage()?>?mid=<?=urlencode($module_id)?>&amp;lang=<?=LANGUAGE_ID?>">
<?
...
?>
	<tr class="heading">
		<td colspan="2"><?=GetMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_OVERDUE")?></td>
	</tr>
	<tr>
		<td width="50%" class="adm-detail-content-cell-l"><?=GetMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_OVERDUE_LETTER")?></td>
		<td width="50%" class="adm-detail-content-cell-r"><input type="checkbox" id="notify_overdue" name="notify_overdue" value="Y"<?=$notifyOverduechecked?>> <?=$linkTempateOverdue?></td>
	</tr>
	<tr>
		<td width="50%" class="adm-detail-content-cell-l"><?=Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_BEFORE_OVERDUE_LETTER")?></td>
		<td width="50%" class="adm-detail-content-cell-r"><input type="checkbox" id="notify_before_overdue" name="notify_before_overdue" value="Y"<?=$notifyBeforeOverdueChecked?>> <?=$linkTempateBeforeOverdue?></td>
	</tr>
	<tr class="overdue_delay_row">
		<td width="50%" class="adm-detail-content-cell-l"><?=Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_DELAY_OVERDUE")?></td>
		<td width="50%" class="adm-detail-content-cell-r">
			<input type="number" size="20" maxlength="255" value="<?=$notifyDelayOverdue?>" name="notify_delay_overdue" min="0" step="1" style="width: 50px;">
	...
	<tr class="heading">
		<td colspan="2"><?=Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_GROUP_BONUSACC")?></td>
	</tr>
	<tr>
		<td width="50%" class="adm-detail-content-cell-l"><?=Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_GROUP_BONUSACC_LETTER")?></td>
		<td width="50%" class="adm-detail-content-cell-r"><input type="checkbox" id="notify_group_bonusacc" name="notify_group_bonusacc" value="Y"<?=$notifyGroupBonusacc?>> <?=$linkTempateBonucAcc?></td>
	</tr>
	<tr>
		<td width="50%" class="adm-detail-content-cell-l"><?=Loc::getMessage("skyweb24.loyaltyprogram_PARAM_NOTIFY_GROUP_BONUSREMOVE_LETTER")?></td>
		<td width="50%" class="adm-detail-content-cell-r"><input type="checkbox" id="notify_group_bonusremove" name="notify_group_bonusremove" value="Y"<?=$notifyGroupBonusremove?>> <?=$linkTempateBonucRemove?></td>
	</tr>
<?
$tabControl->BeginNextTab();
$namesAgent=[
	'\Skyweb24\Loyaltyprogram\Eventmanager::setRanks();'=>Loc::getMessage("skyweb24.loyaltyprogram_AGENT_SETRANKS"),
	'\Skyweb24\Loyaltyprogram\Eventmanager::manageBonuses();'=>Loc::getMessage("skyweb24.loyaltyprogram_AGENT_MANAGEBONUSES"),
	'\Skyweb24\Loyaltyprogram\Eventmanager::birthday();'=>Loc::getMessage("skyweb24.loyaltyprogram_AGENT_BIRTHDAY"),
	'\Skyweb24\Loyaltyprogram\Eventmanager::turnover();'=>Loc::getMessage("skyweb24.loyaltyprogram_AGENT_TURNOVER"),
	'\Skyweb24\Loyaltyprogram\Eventmanager::turnoverRef();'=>Loc::getMessage("skyweb24.loyaltyprogram_AGENT_TURNOVER_REF"),
	'\Skyweb24\Loyaltyprogram\Eventmanager::completedProfile();'=>Loc::getMessage("skyweb24.loyaltyprogram_AGENT_COMPLETEDPROFILE")
];
$res = CAgent::GetList(["ID" => "DESC"], ['MODULE_ID'=>"skyweb24.loyaltyprogram"]);
while($agent=$res->GetNext()){
	...
	<tr>
		...
		<td width="60%" class="adm-detail-content-cell-r"><a href="/bitrix/admin/agent_edit.php?ID=<?=$agent['ID']?>&lang=<?=LANGUAGE_ID?>" target="_blank">#<?=$agent['ID']?></a></td>
	</tr>
<?}
$tabControl->BeginNextTab();
...
$data=Skyweb24\Loyaltyprogram\Rest\Manage::findApp();
if($data==false){
    $str=Loc::getMessage("skyweb24.loyaltyprogram_REST_NOT_PERMISIION");
}else{
    $str=Loc::getMessage("skyweb24.loyaltyprogram_REST_ID_USER").' - <b>'.$data['USER_ID'].'</b>; '.Loc::getMessage("skyweb24.loyaltyprogram_REST_PASSWORDCODE").' - <b>'.$data['PASSWORD'].'</b>';
}
?>
    <tr>
        <td width="40%" class="adm-detail-content-cell-l"><?=Loc::getMessage("skyweb24.loyaltyprogram_REST_PASSWORD")?></td>
        <td width="60%" class="adm-detail-content-cell-r"><span class="data_rest"><?=$str?></span><a class="adm-btn-save adm-btn updaterest" href="#"><?=Loc::getMessage("skyweb24.loyaltyprogram_REST_UPDATEPASSWORD")?></a></td>
    </tr>
<?}else{?>
    <tr>
        <td width="40%" class="adm-detail-content-cell-l"><?=Loc::getMessage("skyweb24.loyaltyprogram_REST_MODULE_NOT_INCLUDED")?></td>
        <td width="60%" class="adm-detail-content-cell-r">
            <a class="adm-btn-save adm-btn updaterest" href="/bitrix/admin/module_admin.php?lang=<?=LANGUAGE_ID?>"><?=Loc::getMessage("skyweb24.loyaltyprogram_REST_MODULE_ACTIVATE")?></a>
        </td>
    </tr>
<?}
$tabControl->BeginNextTab();
...
BX.message({
	'rule':'<?=Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_RULE")?>',
	'deleteRule':'<?=Loc::getMessage("skyweb24.loyaltyprogram_PARAM_REF_RULE_DELETE")?>'
});
...
BX.ready(function(){
	...
	buttonAddRow.innerHTML='<td width="50%" class="adm-detail-content-cell-l"></td>'+
						'<td width="50%" class="adm-detail-content-cell-r"><input type="button" name="addRule" value="<?=Loc::getMessage("skyweb24.loyaltyprogram_ADD")?>" ></td>';
		...
		if(linkRules.length>0){
			for(let i=0; i<linkRules.length; i++){
				...
				if(!nextLinkRules.nextElementSibling || nextLinkRules.nextElementSibling.nodeName!='A' || nextLinkRules.nextElementSibling.className!='rule_link'){
					newLink=BX.create('a', {'attrs':{'class':'rule_link', 'target':'_blank', 'href':'/bitrix/admin/sale_discount_edit.php?ID='+nextLinkRules.value+'&lang=<?=LANGUAGE_ID?>'}, 'text':'<?=Loc::getMessage("skyweb24_loyaltyprogram.EDIT_RULE")?>'});
