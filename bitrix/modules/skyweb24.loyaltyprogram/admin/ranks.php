...
$ranks=new \Skyweb24\Loyaltyprogram\Ranks;
...
if(!empty($_REQUEST['id']) && ($_REQUEST['id']=='new' || (int) $_REQUEST['id']>0)){?>
	...
	<?$aTabs = [
		["DIV" => "sw24_loyal_rank_edit", "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_RANK_NAME"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_RANK_TITLE")]
	];
	...
	<tr>
		<td style="text-align: right" width="50%"><?= Loc::getMessage("skyweb24.ranks_edit_SORT")?></td>
		<td style="text-align: left" width="50%"><input type="number" name="sort" value="<?=$data['sort']?>"></td>
	</tr>
	<tr>
		<td style="text-align: right" width="50%"><?= Loc::getMessage("skyweb24.ranks_edit_COEFF")?></td>
		<td style="text-align: left" width="50%"><input type="number" name="coeff" step=".01" value="<?=$data['coeff']?>"></td>
	</tr>
	<tr>
		<td style="text-align: right" width="50%"><?= Loc::getMessage("skyweb24.ranks_edit_VALUE")?></td>
		<td style="text-align: left" width="50%"><input type="number" name="value" step=".01" value="<?=$data['value']?>"></td>
	</tr>
	<tr>
		<td style="text-align: right" width="50%"><?= Loc::getMessage("skyweb24.ranks_edit_PERIOD")?></td>
	...
	<tr>
		<td style="text-align: right" width="50%"><?= Loc::getMessage("skyweb24.ranks_edit_PROFILES")?></td>
		<td style="text-align: left" width="50%">
	...
	<?/*?><tr>
		<td style="text-align: right" width="50%"><?= Loc::getMessage("skyweb24.ranks_edit_REWRITERANK")?></td>
