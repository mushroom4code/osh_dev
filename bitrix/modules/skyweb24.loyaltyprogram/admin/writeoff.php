...
$APPLICATION->SetTitle(Loc::getMessage("skyweb24.loyaltyprogram_WO_TITLE"));
...
if(empty($request['id'])){
    ...
    $aTabs = [
		["DIV" => "sw24_wo_edit".$currentId, "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_WO_TITLE_SINGLE"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_WO_TITLE_SINGLE")],
		["DIV" => "sw24_wo_history".$currentId, "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_WO_TITLE_HISTORY"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_WO_TITLE_HISTORY")]
    ];
