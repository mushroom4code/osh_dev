...
$groups=new \Skyweb24\Loyaltyprogram\Groups;
...
Skyweb24\Informer::createInfo();
	...
	$aTabs = [
		["DIV" => "sw24_loyal_groups", "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_SETTING_NAME"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_SETTING_TITLE")]
	];
...
?>
	...
	$tabControl->BeginNextTab();?>
		<tr><td width="50%"><?=Loc::getMessage("skyweb24.loyaltyprogram_GROUPS_TYPE")?></td><td><?=SelectBoxFromArray("groups_type", $groupsType, $selectType);?></td></tr>
		...
		foreach($valType as $nextField){
			...
			switch ($nextField['type']){
				...
				case 'user_select':
					...
					$input.='<br><a title="addRow" href="javascript:;" onclick="addUserInput(this)">'.GetMessage("skyweb24.loyaltyprogram_GROUPS_ADD_USER").'</a>';
				break;
			}
