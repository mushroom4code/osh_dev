...
if(!empty($_REQUEST['ajax']) && $_REQUEST['ajax']=='y' && $rights>'D'){
	$importData=new Skyweb24\Loyaltyprogram\Import();
...
$aTabs = [
		["DIV" => "sw24_loyal_import_users", "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_USERS_NAME"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_USERS_TITLE")],
		["DIV" => "sw24_loyal_import_bonus", "TAB" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_BONUS_NAME"), "TITLE" => Loc::getMessage("skyweb24.loyaltyprogram_TAB_BONUS_TITLE")]
	];
...
<tr>
	<td><?CAdminMessage::ShowMessage(['HTML'=>true,'MESSAGE'=>Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_USERS_NOTE")]);?></td>
</tr>
<tr>
	<td>
...
<tr id="refnet_send" style="display:none;">
	<td>
		<button class="adm-btn adm-btn-save"><?=Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_BUTTON_SEND");?></button>
	</td>
</tr>
<tr id="refnet_error" style="display:none;">
	<td>
		<?=CAdminMessage::ShowMessage(Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_UPLOADREFTNETFAIL"));?>
	</td>
</tr>
<tr id="refnet_succes" style="display:none;">
	<td>
		<?=CAdminMessage::ShowNote(Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_UPLOADREFTNETSUCCESS"));?>
	</td>
</tr>
<?$tabControl->BeginNextTab();?>
<tr>
	<td >
		<?CAdminMessage::ShowMessage(['HTML'=>true,'MESSAGE'=>Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_BONUSES_NOTE")]);?>
	</td>
</tr>
<tr>
	<td >
		<?=Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_BONUS_TYPE");?>
		<select id="bonus_type">
			<option value="add"><?=Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_BONUS_TYPE_ADD");?></option>
			<option value="replace"><?=Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_BONUS_TYPE_REPLACE");?></option>
		</select>
		<br>&nbsp;
	</td>
</tr>
...
<tr id="bonus_error" style="display:none;">
	<td>
		<?=CAdminMessage::ShowMessage(Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_UPLOADBONUSFAIL"));?>
	</td>
</tr>
<tr id="bonus_succes" style="display:none;">
	<td>
		<?=CAdminMessage::ShowNote(Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_UPLOADBONUSSUCCESS"));?>
	</td>
</tr>
<?$tabControl->End();?>
</section>
...
BX.message({
	'succesupload':'<?=Loc::getMessage("skyweb24.loyaltyprogram_IMPORT_SUCCES_UPLOAD")?>',
});
