...
<section class="developers pages">
	<article class="JShine">
		<a href="/bitrix/admin/skyweb24_loyaltyprogram_developers.php">
			<figure><img src="/bitrix/images/skyweb24.loyaltyprogram/developers/documentation.png"></figure>
			<header>Documentation</header>
		</a>
	</article>
	<article class="AzurLane">
		<a href="/bitrix/admin/skyweb24_loyaltyprogram_developers.php">
			<figure><img src="/bitrix/images/skyweb24.loyaltyprogram/developers/events.png"></figure>
			<header>Events</header>
		</a>
	</article>
	<article class="KyeMeh">
		<a href="/bitrix/admin/skyweb24_loyaltyprogram_developers.php">
			<figure><img src="/bitrix/images/skyweb24.loyaltyprogram/developers/api.png"></figure>
			<header>API</header>
		</a>
	</article>
	<article class="Magic">
		<a href="/bitrix/admin/skyweb24_loyaltyprogram_developers.php">
			<figure><img src="/bitrix/images/skyweb24.loyaltyprogram/developers/data.png"></figure>
...
<section class="developers articles">
	<article>
		<a href="/bitrix/admin/skyweb24_loyaltyprogram_developers.php">
			<figure><img src="/bitrix/images/skyweb24.loyaltyprogram/developers/writing.png"></figure>
...
<section class="developers video">
	<article>
		<a href="/bitrix/admin/skyweb24_loyaltyprogram_developers.php">
			<figure><img src="/bitrix/images/skyweb24.loyaltyprogram/developers/video.png"></figure>
