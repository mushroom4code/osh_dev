        ...
        BX.ajax({  
            url: '/bitrix/components/skyweb24/order.ajax.bonus2/ajax.php',
                ...
                onsuccess: function(data){
                    //console.log(data)
                    if(data.bonus){
						skyweb24OrderAjaxBonus.blocks.AddedArea.style.display='table-row';
						skyweb24OrderAjaxBonus.blocks.AddedAreaTD.innerHTML=' ~ '+BX.Currency.currencyFormat(data.bonus, skyweb24OrderAjaxBonus.bonuses.currency, true);
                    }
                },
