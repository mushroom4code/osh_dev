...
class loyaltyProgramAccount extends \CBitrixComponent{
	...
	private function getTypetransaction(){
		return [
			'acc'=>[
				'SKYWEB24_LOYAL_REGISTRATION'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_REGISTER"),
				'SKYWEB24_LOYAL_BIRTHDAY'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_BIRTHDAY"),
				'SKYWEB24_LOYAL_ORDERING'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_BONUSADD"),
				'SKYWEB24_LOYAL_PROFILECOMPLETED'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_PROFILECOMPLETED"),
				'SKYWEB24_LOYAL_SUBSCRIBE'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_SUBSCRIBE"),
				'SKYWEB24_LOYAL_TURNOVER'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_TURNOVER"),
				'SKYWEB24_LOYAL_TURNOVERREF'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_TURNOVERREF"),
				'SKYWEB24_LOYAL_IMPORTBONUS'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_IMPORTBONUS"),
				'SKYWEB24_LOYAL_OUTERSOURCE'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_OUTERSOURCE"),
				'SKYWEB24_LOYAL_COPYRIGHTER'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_COPYRIGHTER"),
				...
				'SKYWEB24_LOYAL_BONUSREFUND_LATER'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_ORDER_CANCEL_PART"),
				'SKYWEB24_LOYAL_WRITEOFF'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_WRITEOFF_acc"),
				'SKYWEB24_LOYAL_REVIEWS'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_REVIEWS_acc"),
				'SKYWEB24_LOYAL_GROUPS'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_GROUPS_acc"),
				'MANUAL'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_MANUAL"),
				'EXCESS_SUM_PAID'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_EXCESS_SUM_PAID"),
			],
			'withdraw'=>[
				'SKYWEB24_LOYAL_ORDERPAY'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_BONUSPAY"),
				'ORDER_PAY'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_ORDER_PAY"),
				'SKYWEB24_LOYAL_WRITEOFF'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_WRITEOFF"),
				'SKYWEB24_LOYAL_BONUSREFUND'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_BONUSREFUND"),
				'SKYWEB24_LOYAL_GROUPS'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_GROUPS"),
				'SKYWEB24_LOYAL_BONUSOVERDUE'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_SKYWEB24_LOYAL_BONUSOVERDUE"),
				'MANUAL'=>Loc::getMessage("sw24_loyaltyprogram.TRANSACT_MANUAL"),
	...
	private function getHiddenTransaction(){
		return ['SKYWEB24_LOYAL_BONUSREFUND_LATER'];
	}
	...
	public function executeComponent(){
		...
		if($this->arParams['USER_ID']>0){
			...
			$componentsData=new \Skyweb24\Loyaltyprogram\Components;
			...
			if($this->StartResultCache(false, false, false, $arNavigation, $arrFilter)){
				...
				$writeoff=new Skyweb24\Loyaltyprogram\Writeoff;
