...
var skyweb24_bonus_messages = {
		...
		<?}?>
	var skyweb24_bonus_max = '<?=base64_encode($arParams['MAX_BONUS'])?>';
	var skyweb24_current_bonus = '<?=$arResult['CURRENT_BONUS']['AMOUNT']?>';
	var skyweb24_current_bonus_format = '<?=$arResult['CURRENT_BONUS'][0]['AMOUNT_FORMAT']?>';
	BX.message({hasbonusAdded:'<?=Loc::getMessage('skyweb24.bonus_hasbonusAdded')?>'});
</script>