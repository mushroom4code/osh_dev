 ...
 *
 * @link http://kabinet.pecom.ru/api/v1/
 * @author pecom.ru
 * @package PecomKabinetSDK
 * @version 1.2
 */
...
{
	throw new Exception('Pecom Kabinet SDK requires the CURL PHP extension.');
}
if (!function_exists('json_decode'))
{
	throw new Exception('Pecom Kabinet SDK needs the JSON PHP extension.');
}
