<?
namespace Ipol\Fivepost\Admin\Grid;

use \Ipol\Fivepost\Admin\Grid\AbstractGrid;

/**
 * Class DatabaseGrid
 * @package Ipol\Fivepost\Admin\Grid
 */
abstract class DatabaseGrid extends AbstractGrid
{
    ...
    {
        $query  = $this->getQuery();
        //\Bitrix\Main\Diag\Debug::WriteToFile($query->getQuery(), 'SQL Query', '__fp_GridQuery.log');
        $result = $query->exec();
