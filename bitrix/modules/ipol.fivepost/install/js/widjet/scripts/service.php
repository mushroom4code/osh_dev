...
{
	// auth
	protected static $account = 'ace4abc673358c61919b28922039e49f'; //укажите логин
	protected static $key     = '48662d7f765f4f08c92d852e7af8d8cb'; //укажите ключ
    ...
    {
        return array('автономная область','область','республика','автономный округ','округ','край');
    }
    ...
    {
        return array('поселок городского типа','населенный пункт','курортный поселок','дачный поселок','рабочий поселок','почтовое отделение','сельское поселение','ж/д станция','станция','городок',
                        'деревня','микрорайон','станица','хутор','аул','поселок','село','снт');
    }
