<?php
namespace Osh\Delivery\Restrictions;
...
class ExcludeLocation extends \Bitrix\Sale\Delivery\Restrictions\Base{
    ...
    public static function getClassTitle(){
        return Loc::getMessage("OSH_DELIV_RESTRICTION_CLASS_TITLE");
    }
    public static function getClassDescription(){
        return Loc::getMessage("OSH_DELIV_RESTRICTION_CLASS_DESCRIPTION");
    }
