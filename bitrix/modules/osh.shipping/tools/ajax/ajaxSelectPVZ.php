...
if($_SERVER["REQUEST_METHOD"] == 'POST' && check_bitrix_sessid() && isset($oRequest['id']) 
	...
	$_SESSION['Osh'][$oRequest["deliveryId"]]['PVZ_ID'] = intval($oRequest['id']);
        $_SESSION['Osh'][$oRequest["deliveryId"]]['PVZ_INFO'] = $oRequest["currentPVZ"];
	$arResult['success'] = true;
	$arResult['message'] = Loc::getMessage("ST_OSH_SELECT_PVZ_SUCCESS",array("#SHIPP_ID#" => intval($oRequest['id'])));
}else{
