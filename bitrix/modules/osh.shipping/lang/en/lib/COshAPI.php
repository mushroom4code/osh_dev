<?
$MESS['OSH_API_METHOD_GET_SETTLEMENT'] = 'Метод получения справочника населенных пунктов';
$MESS['OSH_API_METHOD_SUGGEST_SETTLEMENT'] = 'Метод возвращает набор подходящих населенных пунктов';
$MESS['OSH_API_METHOD_GET_SHIPPING_VARIANTS'] = 'Метод получения справочника способов доставки';
$MESS['OSH_API_METHOD_GET_DELIVERY_POINTS'] = 'Метод получения списка ПВЗ';
$MESS['OSH_API_METHOD_GET_DELIVERY_TIME'] = 'Метод получения интервалов забора';
$MESS['OSH_API_METHOD_GET_DAYS_OFF'] = 'Метод получения выходных и праздничных дней';
$MESS['OSH_API_METHOD_CALCULATE_SHIPMENT'] = 'Метод расчета стоимости доставки';
$MESS['OSH_API_METHOD_CALCULATE_SHIPMENT_INTERNATIONAL'] = 'Метод расчета стоимости доставки зарубеж';
$MESS['OSH_API_METHOD_ADD_PACKAGE'] = 'Метод добавления ожидаемой посылки';
$MESS['OSH_API_METHOD_ADD_PACKAGES'] = 'Метод добавления нескольких посылок';
$MESS['OSH_API_METHOD_EDIT_PACKAGE'] = 'Метод редактирования ожидаемой посылки';
$MESS['OSH_API_METHOD_REMOVE_PACKAGE'] = 'Метод удаления посылки';
$MESS['OSH_API_METHOD_GET_PACKAGE'] = 'Метод получения статуса посылки';
$MESS['OSH_API_METHOD_GET_PACKAGES'] = 'Метод получения списка посылок';
$MESS['OSH_API_METHOD_GET_COUNTRIES'] = 'Метод получения списка стран';
$MESS['OSH_API_METHOD_ADD_PRODUCT'] = 'Метод добавления товара';
$MESS['OSH_API_METHOD_EDIT_PRODUCT'] = 'Метод обновления товара';
$MESS['OSH_API_METHOD_ADD_SERVICE'] = 'Метод добавления услуги';
$MESS['OSH_API_METHOD_ADD_PICKUP'] = 'Метод оформления забора груза';
$MESS['OSH_API_METHOD_CANCEL_PICKUP'] = 'Метод отмены забора груза';
$MESS['OSH_API_METHOD_GET_PICKUP'] = 'Метод получения информации о заборе груза';
$MESS['OSH_API_METHOD_GET_PICKUP_TIME'] = 'Метод получения списка интервалов забора';
$MESS['OSH_API_METHOD_GET_COURIER_PICKUP_TIME'] = 'Метод получения списка интервалов забора для курьерской службы';
$MESS['OSH_API_METHOD_GET_PRODUCTS'] = 'Метод получения списка добавленных товаров';
$MESS['OSH_API_METHOD_GET_TRACKING'] = 'Метод отслеживания посылки по ее трек номеру';
$MESS['OSH_API_METHOD_GET_STOCKS'] = 'Получение списка доступных складов';
$MESS['OSH_API_METHOD_GET_PACKAGES_STATUS'] = 'Список посылок, изменивших статус';
$MESS['OSH_API_METHOD_GET_SERVICES'] = 'Список услуг';
$MESS['OSH_API_METHOD_GET_STATUS_LIST'] = 'Список статусов посылки в Osh';
