<?
$MESS["OSH_PVZ_NAME"] = "Пункт выдачи Osh";
$MESS["OSH_MODULE_NAME"] = "Агрегатор служб доставки Osh";
$MESS["OSH_MODULE_DESC"] = "Работа с ведущими службами доставки через единый договор. Доставка по Москве на следующий день, курьерскими службами по РФ в любые ПВЗ и постаматы, Почтой России — в отдаленные уголки. Быстрые взаиморасчеты по наложенному платежу. Возьмем на себя возвраты и задолженности. Заберем заказы у ваших поставщиков, обработаем и передадим на доставку. (Предупреждение: код работает на версиях модуля sale 16.0 и выше!)";
$MESS["OSH_PARTNER_NAME"] = "Osh";
$MESS["OSH_PARTNER_URI"] = "http://osh.ru";
