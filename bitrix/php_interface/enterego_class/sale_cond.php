...
class CSaleCondCtrlBasketFields extends CSaleCondCtrlComplex
{
	...
	public static function GetControls($strControlID = false)
	{
        $arControlList = array(
            ...
            //enterego - add condition on basket type
            'CondBsktFldPriceTypeId' => array(
                'ID' => 'CondBsktFldPriceTypeId',
                'FIELD' => 'PRICE_TYPE_ID',
                'FIELD_TYPE' => 'int',
                'LABEL' => Loc::getMessage('BT_MOD_SALE_COND_BASKET_PRODUCT_PRICE_TYPE_LABEL'),
                'PREFIX' => Loc::getMessage('BT_MOD_SALE_COND_BASKET_PRODUCT_PRICE_TYPE_PREFIX'),
                'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ)),
                'JS_VALUE' => array(
                    'type' => 'input'
                ),
