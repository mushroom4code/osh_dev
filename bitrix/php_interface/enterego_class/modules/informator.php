    ...
    <div class="box_with_boxes">
        <div class="box_with_box_button">
            ...
            <div class="box_with_buttons">
                <p class="box_with_text">Текст в строке информатора</p>
                <textarea name="text_info" class="text_info" rows="8" cols="100"><?= $dateOption->text_info ?? '' ?></textarea>
            </div>
            <div class="box_with_buttons">
                <p class="box_with_text">Ссылка в конце текста</p>
                <input type="text" name="link_info" class="link_info" size="100" value="<?= $dateOption->link_info ?? '' ?>"/>
            </div>
